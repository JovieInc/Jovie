...
id: api-reference
title: API Reference
description: Technical reference for Jovie's public artist profile API and OpenAPI contract.
...
```text
Link: <https://jov.ie/api-versioning>; rel="deprecation"; type="text/html"
```

This policy pointer is discovery only and does not deprecate `v1`. The
