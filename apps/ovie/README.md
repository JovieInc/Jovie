...
This is an intermediate source and build boundary. The 2026-09-23 founder
decision places the final private Ovie app and Mac distribution in the
standalone `JovieInc/ovie` repository. Keep the current Jovie operator paths
working until that app has authenticated, installed-app proof. This workspace
app does not establish the final repository, hostname, or Mac cutover.
