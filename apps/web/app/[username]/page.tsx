...
/**
 * Server component for the /listen mode (DSP links only, lightweight).
 * Extracted to reduce cognitive complexity of ArtistPage.
 */
async function ArtistListenPage({
  username,
  isPublicNoAuthSmoke,
}: {
  readonly username: string;
  readonly isPublicNoAuthSmoke: boolean;
}) {
...
export default async function ArtistPage({
  ...
  if (mode === 'listen') {
    return (
      <ArtistListenPage
        username={username}
        isPublicNoAuthSmoke={isPublicNoAuthSmoke}
      />
    );
  }
