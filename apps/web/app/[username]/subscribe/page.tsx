...
// Redirect sink — issues HTTP 307 to /{username}?mode=subscribe before any
// HTML renders. Marked noindex so crawlers follow the canonical URL instead.
// Note: /{username}/alerts is the canonical indexable subscribe landing page.
