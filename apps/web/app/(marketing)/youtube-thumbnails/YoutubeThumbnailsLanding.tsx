...
/**
 * Apply needs an account and YouTube Connect (JOV-5862). The signed-in
 * apply path itself is owned by the JOV-5158 stack (#16903) — this lander
 * only hands off to it after the visitor has seen their three.
 */
export const YOUTUBE_THUMBNAILS_APPLY_HREF = `${APP_ROUTES.SIGNUP}?source=youtube-thumbnails&intent=apply`;

/** Terminal CTA. One Get started, no standalone SKU. */
  ...
  return (
    <MarketingPageShell className='bg-base text-primary-token'>
      <main>
        ...
        <section
          id='how-it-works'
          aria-labelledby='youtube-thumbnails-how-heading'
        ...
        >
          <MarketingContainer width='page'>
            <div className='mx-auto max-w-3xl text-center'>
              ...
              <h2
                id='youtube-thumbnails-how-heading'
        ...
        <section
          aria-labelledby='youtube-thumbnails-safeguards-heading'
        ...
        >
          <MarketingContainer width='page'>
            <div className='mx-auto max-w-3xl'>
              ...
              <h2
                id='youtube-thumbnails-safeguards-heading'
                className='mt-3 text-balance text-2xl font-semibold tracking-tight sm:text-3xl'
              >
