    ...
    >
      <section className='relative z-10 flex w-full max-w-[360px] flex-col items-center px-6 py-16 text-center'>
        ...
        {isWaitingInBrowser ? null : (
          <button
            type='button'
            className='mt-8 inline-flex h-11 w-full items-center justify-center rounded-full bg-white px-4 text-app font-medium text-black transition-colors hover:bg-white/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/35 disabled:cursor-not-allowed disabled:opacity-55'
