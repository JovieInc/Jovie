...
export default async function InvestorRespondPage({
  ...
  if (action === 'interested') {
    ...
    return (
      <div className='dark flex min-h-screen items-center justify-center bg-base'>
        <div className='text-center'>
          <span className='mb-6 block text-lg font-bold tracking-tight text-primary-token'>
            Jovie
          </span>
          <h1 className='text-2xl font-bold text-primary-token'>
            Thanks For Your Interest!
          </h1>
          <p className='mt-2 text-tertiary-token'>
