...
/**
 * In-flow add surface for public artist profiles and websites. Account-level
 * service authorization lives in Settings > Connections.
 */
      ...
      {view === 'home' ? (
        <DrawerSection sectionKind='details' surface='plain' className='py-1'>
          <ChoiceRow
            ...
            description='Add an artist profile, website, or public page for monitoring.'
        ...
        >
          <div className='flex min-h-72 flex-1 flex-col gap-3 px-3 pb-2'>
            ...
            <p className='text-xs leading-5 text-tertiary-token'>
              ...
              temporary until a supported profile or page is confirmed.
            </p>
          </div>
        </DrawerSection>
      ) : null}
