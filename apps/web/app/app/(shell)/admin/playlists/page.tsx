          ...
          {playlists.map(playlist => (
            <ContentSurfaceCard key={playlist.id} className='p-4'>
              <div className='flex items-start justify-between'>
                <div>
                  <h3 className='text-mid font-[510] text-white'>
                    {playlist.title}
                  </h3>
                ...
                {tab === 'pending' && (
                  <div className='flex gap-2'>
                    <form action={approvePlaylist}>
                      ...
                      <button
                        type='submit'
                        className='rounded-md bg-[#1DB954] px-3 py-1.5 text-app font-[510] text-white hover:opacity-90'
                      >
                        Approve
                      </button>
                    </form>
                    <form action={rejectPlaylist}>
                      ...
                      <button
                        type='submit'
                        className='rounded-md bg-white/5 px-3 py-1.5 text-app font-[450] text-white/60 hover:bg-white/10'
                      >
                        Reject
                      </button>
                    </form>
