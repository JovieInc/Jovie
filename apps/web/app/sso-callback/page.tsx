 ...
 * This handles OAuth flows that don't go through the specific /signin or /signup routes.
 */
  ...
  useEffect(() => {
    ...
    if (isSignedIn && user) {
      ...
      if (user.createdAt) {
        ...
        if (ageInSeconds < 30) {
          console.log(
            '[SSO_CALLBACK] Fresh signup detected, redirecting with flag'
          );
      ...
      console.log(
        '[SSO_CALLBACK] Existing user detected, redirecting to dashboard'
      );
