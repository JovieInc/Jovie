...
- TLS everywhere plus encryption-at-rest on all databases
- Secure authentication flows powered by Clerk
- Role-based access controls, logging, and routine security reviews
- Minimal data retention aligned with the principle of least privilege
...
If you have questions about this policy or your data, email privacy@jov.ie.
