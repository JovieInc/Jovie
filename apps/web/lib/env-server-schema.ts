...
export const ServerEnvSchema = z.object({
  ...
  /**
   * Base URL for YouTube connector OAuth callback, e.g. https://jov.ie/api/connectors/youtube.
   * Falls back to request origin + /api/connectors/youtube when unset.
   * Reuses GOOGLE_OAUTH_CLIENT_ID/SECRET — enable YouTube Data API v3 and register the
   * redirect URI `{base}/callback` in the OAuth client console.
   */
