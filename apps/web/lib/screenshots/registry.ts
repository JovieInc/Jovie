...
export const SCREENSHOT_SCENARIOS: readonly ScreenshotScenario[] = [
  ...defineScenarios('marketing', ADMIN_AND_INVESTOR, [
    ...
    },
    {
      ...
      route: '/demo/audience?capture=quality',
      waitFor: '[data-testid="demo-audience-capture-quality"]',
      captureTarget: 'locator',
      captureSelector: '[data-testid="demo-audience-capture-quality"]',
      publicExportPath: 'artist-spec-audience-quality-desktop.png',
    },
    {
      id: 'artist-spec-fan-list-desktop',
      title: 'Artist Spec — Fan List',
      route: '/demo/audience?capture=crm',
      waitFor: '[data-testid="demo-audience-capture-crm"]',
      captureTarget: 'locator',
      captureSelector: '[data-testid="demo-audience-capture-crm"]',
      publicExportPath: 'artist-spec-fan-list-desktop.png',
    },
    {
      id: 'artist-spec-creator-menu-mobile',
      title: 'Artist Spec — Creator Menu',
      route: '/demo/showcase/release-landing?capture=creator-menu',
      waitFor: '[data-testid="release-landing-menu-drawer"]',
      captureTarget: 'locator',
      captureSelector: '[data-testid="release-landing-menu-drawer"]',
      viewport: 'mobile',
    ...
    {
      id: 'artist-spec-retargeting-desktop',
      title: 'Artist Spec — Retargeting',
      route: '/demo/audience?capture=retargeting',
      waitFor: '[data-testid="demo-audience-capture-retargeting"]',
      captureTarget: 'locator',
      captureSelector: '[data-testid="demo-audience-capture-retargeting"]',
      publicExportPath: 'artist-spec-retargeting-desktop.png',
    },
    {
      ...
      waitFor: '[data-testid="profile-about-press-photos"]',
      captureTarget: 'locator',
      captureSelector: '[data-testid="profile-about-press-photos"]',
      viewport: 'mobile',
      publicExportPath: 'artist-spec-press-assets-mobile.png',
    },
    {
      id: 'artist-spec-tracked-links-desktop',
      title: 'Artist Spec — Tracked Links',
