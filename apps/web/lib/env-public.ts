...
const PublicEnvSchema = z.object({
  ...
  // Domain configuration - single domain (jov.ie)
  ...
  NEXT_PUBLIC_APP_HOSTNAME: z.string().default('jov.ie'),
...
const rawPublicEnv = {
  ...
  NEXT_PUBLIC_APP_HOSTNAME: process.env.NEXT_PUBLIC_APP_HOSTNAME || 'jov.ie',
