...
const PublicEnvSchema = z.object({
  ...
  // Domain configuration - single domain for auth (meetjovie.com)
  NEXT_PUBLIC_APP_URL: z.string().url().default('https://meetjovie.com'),
  ...
  NEXT_PUBLIC_APP_HOSTNAME: z.string().default('meetjovie.com'),
...
const rawPublicEnv = {
  ...
  // Domain configuration - single domain for auth (meetjovie.com)
  NEXT_PUBLIC_APP_URL:
    process.env.NEXT_PUBLIC_APP_URL ?? 'https://meetjovie.com',
