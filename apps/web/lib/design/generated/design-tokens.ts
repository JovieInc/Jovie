...
export const DESIGN_TOKENS = {
  ...
  "duration": {
    "$description": "Motion durations. Canonical values are styles/design-system.css --duration-*. --linear-duration-* aliases those tokens (JOV-5302).",
    "fast": "100ms",
    "normal": "160ms",
    "slow": "250ms"
  },
  "divergences": {
    "$description": "Known same-concept/different-value pairs across legacy namespaces, tracked for the namespace-collapse wave. Do NOT silently unify these — each is a visual change requiring its own migration slice. JOV-5302 resolved accent-blue by aliasing --linear-accent-* onto --color-accent-*."
  }
} as const;
