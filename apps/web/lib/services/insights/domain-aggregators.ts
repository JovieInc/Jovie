...
export function computeCityGrowthRates(
...
export function computeReferrerGrowthRates(
...
export interface ClickAggregateResult {
...
export interface AudienceAggregateResult {
  totalMembers: number;
...
export interface SubscriberAggregateResult {
...
export async function aggregateSubscribers(
  profileId: string,
  period: { start: Date; end: Date },
  comparisonPeriod: { start: Date; end: Date }
...
export interface TourAggregateResult {
  upcomingShows: {
    city: string;
    country: string;
    date: string;
...
export async function aggregateTourData(
  profileId: string,
...
export async function aggregateTemporalPatterns(
  profileId: string,
  period: { start: Date; end: Date }
