...
export const COOKIE_REGISTRY = [
  ...
  {
    name: '__Secure-better-auth.',
    match: 'prefix',
    category: 'essential',
    purpose: 'Secure authentication session cookies on HTTPS origins.',
    duration: 'Session',
    ttlSeconds: null,
    preConsent: true,
  },
  {
    name: '__Host-better-auth.',
    match: 'prefix',
    category: 'essential',
    purpose: 'Host-scoped authentication session cookies on HTTPS origins.',
    duration: 'Session',
    ttlSeconds: null,
    preConsent: true,
  },
