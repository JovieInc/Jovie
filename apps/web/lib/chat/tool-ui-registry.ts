...
export const TOOL_UI_REGISTRY = {
  ...
  publishMerchCard: {
    ...
    uiHint: 'artifact',
    renderer: 'artifact',
    loadingTitle: 'Preparing publish…',
    successTitle: 'Publish merch',
    errorTitle: "Couldn't prepare publish",
  },
  pauseMerchCard: {
    label: 'Merch pause',
    uiHint: 'artifact',
  ...
  unpauseMerchCard: {
    ...
    uiHint: 'artifact',
    renderer: 'artifact',
    loadingTitle: 'Preparing unpause…',
    successTitle: 'Make merch live',
    errorTitle: "Couldn't prepare unpause",
  },
  deleteOrArchiveMerchCard: {
    label: 'Merch archive',
    uiHint: 'artifact',
    renderer: 'artifact',
    loadingTitle: 'Preparing archive…',
    successTitle: 'Archive merch',
    errorTitle: "Couldn't prepare archive",
  },
  reorderMerchCards: {
    label: 'Merch order',
    uiHint: 'status',
