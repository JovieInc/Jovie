 ...
 * JOV-5186, JOV-5187, JOV-5209, JOV-5218, JOV-5220, JOV-5221, JOV-5228,
 ...
 * on `message` so a real `UpstashError: ERR max requests…` exception stays
 * visible. Next.js request wrappers keep the bag on `cause`; walk a bounded
 * chain.
 */
