...
export function scrubPii(
  ...
  // Filter captureWarning/captureError JSON bags (JOV-5183, JOV-5186,
  // JOV-5187, JOV-5209, JOV-5218, JOV-5228). Real Upstash quota exceptions
  // keep their command-failure title.
