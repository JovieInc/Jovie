...
// Files listed in tests/node-environment-files.json run in Vitest's `node`
// environment (see vitest.config.fast.mts) and have no DOM; the jsdom-only
// shims below are skipped there instead of throwing.
