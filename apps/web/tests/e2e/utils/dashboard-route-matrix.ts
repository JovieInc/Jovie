...
export const EXCLUDED_ROUTES: Record<string, string> = {
  ...
  '/:username/profile-mode-render/:profileMode/:marker':
    'Internal profile render alias (ISR)',
  '/auth/ios/complete': 'iOS auth handoff page',
  '/auth/native-complete': 'Native auth completion page',
  '/auth/native-return': 'Native auth return bounce page',
  '/demo/founder-video': 'Internal demo',
  '/drop/:token': 'Token-gated share drop (dynamic)',
  '/engineering/preview': 'Noindex preview',
  '/engineering/preview/:slug': 'Noindex preview',
  '/hud-tv': 'Legacy redirect to /hud',
  '/hud/wiki': 'Internal admin wiki',
  '/hud/wiki/...slug': 'Internal admin wiki',
  '/p/:token': 'Token-gated asset share (dynamic)',
  '/renders': 'Internal render fixture index',
  '/renders/:state': 'Internal render fixture',
  '/renders/profile-admission': 'E2E-only admission fixture',
  '/renders/surfaces/:surface': 'Internal render fixture',
  '/ui/parallax': 'Component showcase',
