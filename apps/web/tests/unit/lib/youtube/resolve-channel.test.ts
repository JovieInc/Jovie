...
describe('parseYouTubeChannelInput', () => {
  it.each([
    ...
    ['https://www.youtube.com/@itstimwhite', { kind: 'handle', value: 'itstimwhite' }],
    ['youtube.com/@itstimwhite/videos', { kind: 'handle', value: 'itstimwhite' }],
    ['https://m.youtube.com/c/timwhite', { kind: 'username', value: 'timwhite' }],
    ['https://youtube.com/user/timwhite', { kind: 'username', value: 'timwhite' }],
    [
      'https://www.youtube.com/channel/UCabcdefghijklmnopqrstuv',
      { kind: 'id', value: 'UCabcdefghijklmnopqrstuv' },
    ],
    ['UCabcdefghijklmnopqrstuv', { kind: 'id', value: 'UCabcdefghijklmnopqrstuv' }],
      ...
      .mockResolvedValueOnce(
        jsonOk({
          items: [
            ...
            {
              id: 'nothumb',
              snippet: { title: 'No thumb', publishedAt: '2026-07-01T00:00:00Z' },
              status: { privacyStatus: 'public' },
            },
          ],
        })
