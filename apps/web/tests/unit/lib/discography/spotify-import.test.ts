...
const mockGetSpotifyArtistAlbums = vi
  .fn()
  .mockResolvedValue({ albums: [], total: 0 });
...
describe('spotify-import', () => {
  beforeEach(() => {
    ...
    mockGetSpotifyArtistAlbums.mockResolvedValue({ albums: [], total: 0 });
        ...
        albums: [
          {
            ...
            external_urls: {
              spotify: 'https://open.spotify.com/album/album-ep',
            },
          },
        ],
        total: 1,
