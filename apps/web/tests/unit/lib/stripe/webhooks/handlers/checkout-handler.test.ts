...
import { CheckoutSessionHandler, checkoutSessionHandler } from '@/lib/stripe/webhooks/handlers/checkout-handler';
...
describe('CheckoutSessionHandler', () => {
  ...
  describe('singleton instance', () => {
    it('exports a singleton handler instance', () => {
      ...
      expect(checkoutSessionHandler.eventTypes).toContain('checkout.session.completed');
    });
  });
});
