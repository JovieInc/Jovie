 ...
 * no hex/rgba/gradient colors, no raw color scales, no literal white/black
 * utilities, no arbitrary values, no inline styles, no named shadow scales,
 * and no System A editorial type classes (marketing-*-linear / marketing-kicker).
 */
...
describe('homepage v2 (/new) System B source contract', () => {
  it('keeps /new visuals on named System B primitives', () => {
