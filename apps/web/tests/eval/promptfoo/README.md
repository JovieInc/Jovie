...
- A deterministic AI skill prompt adapter, covering release-pitch prompt builders and retouch style prompt guardrails with synthetic Luna Waves fixtures and no model, DB, or network calls.
