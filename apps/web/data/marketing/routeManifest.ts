...
export const MARKETING_ROUTE_MANIFEST: readonly RouteManifestEntry[] = [
  ...
  // waitlist — public auth front door; route lives outside (marketing)/ but manifest binds it
  {
    ...
    bindingEvidence: {
      status: 'verified',
      source: 'JOV-5334 public waitlist front door',
      notes:
        'Signed-out visitors render the canonical auth shell; authenticated states continue through the existing start or receipt flow.',
    },
    status: 'active',
    specVersion: '1.0.0',
    url: '/waitlist',
