...
const rows = [
  ...
  'banner|apps/web/components/feedback/Banner.tsx|Banner|default success warning error|viewport-feedback|no-focus-transfer|passive-status|explicit|subtle|top-inline|top-inline|top-inline|apps/web/components/feedback/Feedback.stories.tsx|apps/web/tests/unit/components/feedback/feedback-system.test.ts|ErrorBanner StatusBanner InstallBanner',
