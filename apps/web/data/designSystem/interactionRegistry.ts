...
const rows = [
  ...
  'picker|packages/ui/atoms/select.tsx|Select|default focus-visible selected disabled loading error collapsed expanded|anchored-floating|return-to-trigger|listbox-navigation|escape-outside-or-select|subtle|edge-aware|anchored|anchored|packages/ui/atoms/select.stories.tsx|packages/ui/atoms/select.test.tsx|GenrePicker LocationPicker ContactTerritoryPicker',
