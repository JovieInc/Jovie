                ...
                canCreateManualReleases ? (
                  <Button
                    ...
                    className={cn(
                      ...
                      'h-9 rounded-[9px] border-(--linear-border-subtle) bg-transparent px-3.5 text-[13px] font-[510] text-(--linear-text-secondary) hover:bg-(--linear-bg-surface-1) hover:text-(--linear-text-primary) [&_svg]:h-3.5 [&_svg]:w-3.5'
                    )}
                  >
                    <Icon
                      name='Plus'
