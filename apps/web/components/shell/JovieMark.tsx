...
/**
 * JovieMark — the Jovie brand icon as an inline SVG, sized via className.
 *
 * Server-safe (no hooks, no state). Renders the official Jovie mark using
 ...
 * surfaces that just need the path with className-driven sizing.
 *
 * @example
 * ```tsx
