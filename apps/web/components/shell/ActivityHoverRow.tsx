...
export function ActivityHoverRow({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'group/act flex items-center gap-2.5 h-8 px-2 rounded-md text-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/55 focus-visible:ring-offset-2 focus-visible:ring-offset-(--color-bg-page) transition-colors duration-subtle ease-subtle',
        danger
