    ...
    <div className={cn('md:hidden fixed inset-x-3 z-40 bottom-3', className)}>
      <div className='rounded-2xl px-2.5 py-2 flex items-center gap-2.5 backdrop-blur-2xl bg-(--linear-app-content-surface)/70 border border-(--linear-app-frame-seam) shadow-[0_10px_40px_rgba(0,0,0,0.18)] relative overflow-hidden'>
        ...
        <button
          type='button'
          onClick={onPlay}
          className='h-9 w-9 rounded-full grid place-items-center border border-(--color-btn-primary-border) bg-btn-primary text-btn-primary-foreground shadow-button-inset shrink-0 transition-colors duration-subtle ease-subtle hover:border-(--color-btn-primary-hover) hover:bg-btn-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/55 focus-visible:ring-offset-2 focus-visible:ring-offset-(--color-bg-page) outline-none'
