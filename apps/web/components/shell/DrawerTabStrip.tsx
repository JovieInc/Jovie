        ...
        {tabs.map(t => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex-1 h-7 px-3 rounded-full text-2xs font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-token transition-colors duration-subtle ease-subtle',
                on
