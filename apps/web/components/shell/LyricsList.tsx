...
const LyricListRow = memo(function LyricListRow({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className='group/lyric w-full flex items-start gap-2 px-2 py-1.5 rounded-md text-xs text-secondary-token hover:bg-surface-1/40 hover:text-primary-token disabled:cursor-default disabled:hover:bg-transparent disabled:hover:text-secondary-token focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/55 focus-visible:ring-offset-2 focus-visible:ring-offset-(--color-bg-page) transition-colors duration-subtle ease-subtle text-left'
    >
        ...
        {onEdit && (
          <button
            ...
            className={cn(
              ...
              'hover:text-primary-token focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/55 focus-visible:ring-offset-2 focus-visible:ring-offset-(--color-bg-page) rounded transition-colors duration-subtle ease-subtle'
            )}
          >
            {editLabel}
          </button>
