          ...
          <p className={FORM_LAYOUT.hint} id='otp-description'>
            ...
            {email && (
              <>
                ...
                <span className='text-[#1f2023] dark:text-[#e3e4e6] font-[400] break-all'>
                  {email}
                </span>
                {'.'}
              </>
        ...
        <form onSubmit={handleSubmit} className={FORM_LAYOUT.formContainer}>
          ...
          <div className={FORM_LAYOUT.footerHint}>
            ...
            <button
              ...
              disabled={isLoading}
              className='text-[#1f2023] dark:text-[#e3e4e6] underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6c78e6]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-[#f5f5f5] dark:focus-visible:ring-offset-[#090909] rounded-md disabled:opacity-50 disabled:cursor-not-allowed'
            >
