...
export function OnboardingInterviewModal({
  ...
  return (
    <dialog
      ...
      className='jovie-auth-modal fixed inset-0 m-auto h-auto max-h-[calc(100svh-48px)] w-full max-w-120 overflow-auto rounded-lg border border-(--linear-border-subtle) bg-(--linear-bg-surface-0) p-6 text-primary-token shadow-(--linear-shadow-card-elevated) backdrop:bg-(--linear-bg-page) backdrop:backdrop-blur-sm'
    >
