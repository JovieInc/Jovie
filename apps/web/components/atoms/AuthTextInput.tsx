...
const authTextInputClasses =
  'border border-subtle bg-surface-0 text-primary-token placeholder:text-tertiary-token rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--linear-border-focus)/40 focus-visible:ring-offset-2 h-(--linear-button-height-md) min-h-[40px] px-3 text-(--linear-caption-size) font-(--linear-caption-weight)';
