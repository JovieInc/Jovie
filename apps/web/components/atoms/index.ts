...
export type {
  ...
  AvatarUploadStatus,
} from './AvatarUploadAnnouncer';
export { AvatarUploadAnnouncer } from './AvatarUploadAnnouncer';
...
export type { FrostedButtonProps } from './FrostedButton';
export { FrostedButton } from './FrostedButton';
