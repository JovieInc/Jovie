...
export const OptimizedImage = React.memo(function OptimizedImage({
  ...
  return (
    <div className={containerClasses}>
      ...
      {isLoading && (
        <div className='absolute inset-0 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 animate-pulse motion-reduce:animate-none' />
      )}
    </div>
  );
});
