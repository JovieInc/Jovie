  ...
  return (
    <div className='flex items-center gap-2.5'>
      ...
      <button
        ...
        className='flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white/90 text-black transition-[transform,scale] duration-100 hover:scale-105 active:scale-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/70'
      >
        {isPlaying ? (
