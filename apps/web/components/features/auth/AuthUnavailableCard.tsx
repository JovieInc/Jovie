  ...
  return (
    ...
    >
      <div className='flex justify-center lg:justify-start'>
        <div className='inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-xs font-[510] tracking-[-0.012em] text-white/70'>
          <span
            aria-hidden='true'
      ...
      <p className='text-xs leading-[1.6] tracking-[-0.01em] text-white/40'>
