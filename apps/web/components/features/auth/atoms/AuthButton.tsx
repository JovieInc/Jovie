...
const authButtonVariants = cva(
  [
    // Base styles
    'w-full rounded-full flex items-center justify-center gap-(--linear-gap-buttons)',
  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        link: [
          'bg-transparent p-0 h-auto min-h-0 text-app font-normal text-secondary-token',
