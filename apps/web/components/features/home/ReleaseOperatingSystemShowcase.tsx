...
export function ReleaseOperatingSystemShowcase() {
  return (
    <div data-testid='homepage-release-operating-system-surface'>
      ...
      <div className='relative hidden min-h-[38rem] overflow-hidden rounded-[2rem] border border-white/8 bg-[linear-gradient(180deg,rgba(14,16,22,0.82),rgba(8,10,15,0.64))] p-6 shadow-[0_36px_110px_rgba(0,0,0,0.34)] lg:block'>
        <div
          aria-hidden='true'
        ...
        <div
          className='absolute left-6 top-6 z-20 w-[21rem]'
        ...
        <div
          className='absolute right-6 top-10 z-10 w-[41rem]'
        ...
        <div className='absolute bottom-6 left-12 z-30 w-[16rem]'>
          <MonitoringPanel />
        </div>
      </div>
    </div>
