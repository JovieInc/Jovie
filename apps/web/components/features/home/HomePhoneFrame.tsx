  ...
  return (
    ...
    >
      ...
      <div className='homepage-phone-device relative w-full rounded-[2.65rem] p-2 shadow-[0_28px_84px_rgba(0,0,0,0.42)]'>
        ...
        <div
          aria-hidden='true'
          className='pointer-events-none absolute left-[11%] right-[11%] top-3 h-6 rounded-full bg-black'
        />
        <div
          aria-hidden='true'
        ...
        <div className='homepage-phone-screen relative aspect-[430/950] overflow-hidden rounded-[2.2rem] bg-black'>
          <div
            aria-hidden='true'
            className='pointer-events-none absolute left-1/2 top-3 z-[18] h-10 w-32 -translate-x-1/2 rounded-full bg-black shadow-[0_8px_24px_rgba(0,0,0,0.32)]'
          />
          <div
            aria-hidden='true'
          ...
          >
            ...
            <div className='flex items-center gap-2.5'>
              ...
              <div className='relative h-3 w-6 rounded-xs border-[1.8px] border-white/92'>
                <span className='absolute inset-1 rounded-xs bg-white' />
