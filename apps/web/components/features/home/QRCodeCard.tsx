...
export function QRCodeCard({ handle }: QRCodeCardProps) {
  ...
  return (
    <div className='relative group'>
      ...
      <div className='relative p-4 bg-surface-0/80 backdrop-blur-xl rounded-2xl border border-subtle shadow-xl hover:shadow-2xl transition-[box-shadow,transform] duration-200 hover:-translate-y-1'>
