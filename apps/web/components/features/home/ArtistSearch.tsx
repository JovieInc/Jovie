    ...
    <form onSubmit={handleSubmit} className='w-full'>
      <div className='relative'>
        <input
          ...
          className='w-full px-4 py-3 pl-12 pr-4 text-lg bg-surface-0/80 backdrop-blur-sm border border-default rounded-xl text-primary-token placeholder:text-tertiary-token focus-visible:ring-2 focus-visible:ring-accent focus-visible:border-transparent transition-[border-color,box-shadow] duration-300'
