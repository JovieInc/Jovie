  ...
  return (
    <div className='absolute inset-0 min-h-130'>
      <button
        ...
        className='absolute inset-0 rounded-2xl bg-[color-mix(in_oklab,var(--app-shell-content-surface)_82%,var(--app-shell-border)_18%)] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring'
      />
