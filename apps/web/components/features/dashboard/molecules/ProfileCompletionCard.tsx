            ...
            <ul className='space-y-1.5'>
              {primarySteps.map(step => (
                <li key={step.id}>
                  <Link
                    href={step.href}
                    className='group flex items-center justify-between gap-3 rounded-[9px] border border-transparent px-3 py-2 transition-[background-color,border-color] duration-150 hover:border-(--linear-app-frame-seam) hover:bg-surface-0'
                  >
