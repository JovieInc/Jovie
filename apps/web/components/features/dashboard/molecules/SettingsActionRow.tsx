  ...
  return (
    ...
    >
      <div className='flex min-w-0 items-start gap-3'>
        {icon ? (
          <div className='flex h-8 w-8 shrink-0 items-center justify-center rounded-[10px] border border-(--linear-app-frame-seam) bg-surface-0 text-secondary-token'>
            {icon}
          </div>
        ) : null}
        <div className='min-w-0'>
          ...
          {description ? (
            <p
              className={cn(
                'mt-1 max-w-[56ch] text-[13px] leading-[18px] text-secondary-token',
                descriptionClassName
              )}
            >
              {description}
