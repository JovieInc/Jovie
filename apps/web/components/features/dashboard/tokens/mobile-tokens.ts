...
export const mobileReleaseTokens = {
  list: 'overflow-hidden rounded-2xl border border-subtle bg-(--app-shell-content-surface)',
  row: {
    container:
  ...
  groupHeader:
    'sticky top-0 z-10 flex items-center justify-between border-b border-subtle bg-(--app-shell-content-surface) px-4 py-2',
