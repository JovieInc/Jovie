...
export const mobileReleaseTokens = {
  ...
  swipeActions: {
    ...
    edit: 'bg-[color-mix(in_oklab,var(--linear-bg-surface-1)_72%,var(--color-accent-purple))] active:bg-[color-mix(in_oklab,var(--linear-bg-surface-1)_60%,var(--color-accent-purple))]',
