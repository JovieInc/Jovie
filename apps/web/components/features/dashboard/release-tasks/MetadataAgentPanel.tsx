      ...
      {storageAvailable ? (
        <div className='mt-4 flex flex-wrap gap-2'>
          <button
            ...
            className='rounded-md border border-(--color-btn-primary-border) bg-btn-primary px-3 py-2 text-sm font-medium text-btn-primary-foreground shadow-button-inset transition-colors duration-subtle hover:border-(--color-btn-primary-hover) hover:bg-btn-primary-hover disabled:cursor-not-allowed disabled:opacity-60'
          >
