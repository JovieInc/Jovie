...
export function AudienceSubscriberRow({
  ...
  return (
    <tr
      ...
      ref={measureRef}
      className={cn(
        'group cursor-pointer border-b border-subtle transition-[background-color,box-shadow] duration-subtle last:border-b-0 hover:bg-(--linear-row-hover) focus-visible:outline-none focus-visible:bg-(--linear-row-hover) focus-visible:shadow-inset-ring-focus',
