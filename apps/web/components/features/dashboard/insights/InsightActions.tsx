  ...
  return (
    <div className='flex items-center gap-2'>
      <Button
        ...
        className='h-8 gap-1.5 rounded-full border border-transparent px-2.5 text-[12px] font-[510] tracking-[-0.01em] text-tertiary-token transition-[background-color,color,border-color,box-shadow] duration-150 hover:border-subtle hover:bg-surface-0 hover:text-secondary-token focus-visible:border-(--linear-border-focus) focus-visible:bg-surface-0 focus-visible:ring-2 focus-visible:ring-(--linear-border-focus)/20'
      >
        <X className='h-3 w-3' />
        Dismiss
      </Button>
      <Button
        ...
        className='h-8 gap-1.5 rounded-full border border-transparent px-2.5 text-[12px] font-[510] tracking-[-0.01em] text-secondary-token transition-[background-color,color,border-color,box-shadow] duration-150 hover:border-subtle hover:bg-surface-0 hover:text-primary-token focus-visible:border-(--linear-border-focus) focus-visible:bg-surface-0 focus-visible:ring-2 focus-visible:ring-(--linear-border-focus)/20'
      >
