  ...
  return (
    <div className='flex items-center gap-2'>
      <Button
        ...
        className='h-7 gap-1 rounded-[8px] border border-transparent px-2.5 text-[11px] font-[510] tracking-[-0.01em] text-tertiary-token transition-[background-color,color,border-color,box-shadow] duration-150 hover:border-(--linear-app-frame-seam) hover:bg-surface-1 hover:text-secondary-token focus-visible:border-(--linear-border-focus) focus-visible:bg-surface-1 focus-visible:ring-1 focus-visible:ring-(--linear-border-focus)/20'
      >
        <X className='h-3 w-3' />
        Dismiss
      </Button>
      <Button
        ...
        className='h-7 gap-1 rounded-[8px] border border-transparent px-2.5 text-[11px] font-[510] tracking-[-0.01em] text-secondary-token transition-[background-color,color,border-color,box-shadow] duration-150 hover:border-(--linear-app-frame-seam) hover:bg-surface-1 hover:text-primary-token focus-visible:border-(--linear-border-focus) focus-visible:bg-surface-1 focus-visible:ring-1 focus-visible:ring-(--linear-border-focus)/20'
      >
