      ...
      <div className={`w-full max-w-md ${FORM_LAYOUT.formContainer}`}>
        ...
        >
          <input
            ...
            maxLength={50}
            autoComplete='name'
            className='w-full rounded-md border border-subtle bg-surface-1 px-3 py-2.5 text-primary-token placeholder:text-tertiary-token focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/30 focus-visible:ring-offset-1 focus-visible:ring-offset-(--app-shell-content-surface)'
          />
