  ...
  return (
    <li className={containerClass}>
      ...
      {!isComplete && (
        <Link
          href={actionHref}
          className='rounded-full border border-transparent px-2.5 py-1 text-[12px] font-[510] text-secondary-token transition-[background-color,border-color,color] hover:border-subtle hover:bg-surface-0 hover:text-primary-token'
        >
