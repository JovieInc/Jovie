  ...
  if (compact) {
    if (syncState === 'no_match') {
      return (
        <div
          className={cn(
            'inline-flex h-7.5 items-center gap-2 rounded-[6px] border border-[#FA243C]/18 bg-[#FA243C]/6 px-2.5 text-[11.5px] text-secondary-token',
            className
          )}
        >
    ...
    return (
      <div
        className={cn(
          'inline-flex h-7.5 items-center gap-2 rounded-[6px] border border-[#FA243C]/18 bg-[#FA243C]/6 px-2 text-[11.5px] text-primary-token',
          className
        )}
      >
        <DspProviderIcon provider='apple_music' size='sm' />
        ...
        <DrawerButton
          ...
          className='h-6 rounded-[6px] border-[#FA243C] bg-[#FA243C] px-2 text-[11px] hover:border-[#FA243C] hover:bg-[#FA243C]/90'
        >
          Confirm
        </DrawerButton>
      </div>
