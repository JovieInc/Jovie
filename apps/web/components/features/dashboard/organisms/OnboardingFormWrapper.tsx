    ...
    >
      <div className='flex h-full flex-col items-center justify-center'>
        <div className='flex w-full max-w-md flex-col'>
          ...
          <div className='rounded-xl border border-subtle bg-[color-mix(in_oklab,var(--app-shell-content-surface)_96%,var(--linear-bg-surface-0))] p-4 sm:p-5'>
            <div className='w-full space-y-3'>
              <div className='flex w-full items-center gap-3 rounded-full border border-subtle bg-[color-mix(in_oklab,var(--app-shell-content-surface)_94%,var(--linear-bg-surface-0))] px-4 py-3'>
