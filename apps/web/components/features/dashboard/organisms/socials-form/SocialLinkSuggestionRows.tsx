...
export function SocialLinkSuggestionRows({
  ...
  return (
    <div className='space-y-2'>
      <p className='text-[13px] font-caption text-secondary-token'>
        Detected profiles
      </p>
          ...
          return (
            ...
            >
              ...
              <div className='min-w-0 flex-1'>
                <p className='text-[13px] font-caption text-primary-token truncate'>
              ...
              <div className='flex items-center gap-1.5 shrink-0'>
                <button
                  ...
                  className={cn(
                    'inline-flex items-center gap-1 px-2 py-1 text-[13px] font-caption rounded-md',
