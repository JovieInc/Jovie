...
function MenuItemLink({
  ...
  return (
    <Link
      href={item.href}
      className={cn(
        'flex items-center gap-3 rounded-[8px] px-3 py-2.5 text-[13px] font-[510] transition-[color,background-color,border-color,transform] duration-150',
        'active:scale-[0.98]',
        active
...
export function LiquidGlassMenu({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'absolute inset-x-0 bottom-full transition-opacity duration-300 ease-out',
          isExpanded
      ...
      >
        ...
        <div
          className={cn(
            'relative z-50 mx-3 mb-2 overflow-hidden rounded-[12px] transition-[transform,translate,scale] duration-300 ease-out',
              ...
              {onSignOut && (
                <>
                  ...
                  <button
                    type='button'
                    onClick={onSignOut}
                    className='flex w-full items-center gap-3 rounded-[8px] px-3 py-2.5 text-[13px] font-[510] text-secondary-token transition-[color,background-color,border-color,transform] duration-150 hover:bg-surface-1 hover:text-primary-token active:scale-[0.98]'
                  >
                    <LogOut
        ...
        <div className='relative z-10 flex items-stretch justify-around px-2 pb-[calc(env(safe-area-inset-bottom)+4px)] pt-1.5'>
          ...
          {primaryItems.slice(0, 4).map(item => {
            ...
            return (
              <Link
                ...
                className={cn(
                  'relative flex min-w-[64px] flex-col items-center justify-center gap-0.5 rounded-[8px] py-1.5 transition-[color,background-color,border-color,transform] duration-150',
                  'active:scale-95',
                  active
                    ? 'text-primary-token'
          ...
          {onSearchClick && (
            <button
              ...
              aria-label='Search'
              className='relative flex min-w-[64px] flex-col items-center justify-center gap-0.5 rounded-[8px] py-1.5 text-tertiary-token transition-[color,background-color,border-color,transform] duration-150 hover:text-secondary-token active:scale-95'
            >
