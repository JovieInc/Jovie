      ...
      <div className='flex w-4 shrink-0 items-center justify-center'>
        {hasPreview && (
          <DrawerInlineIconButton
            ...
            className={cn(
              'h-4 w-4 rounded-xs p-0 transition-opacity duration-150 focus-visible:opacity-100',
              isPlaying
      ...
      {onSelect ? (
        ...
        >
          ...
          {artistLine ? (
            <TruncatedText
              lines={1}
              className='mt-px text-2xs font-normal leading-[1.2] tracking-[-0.005em] text-secondary-token'
            >
              {artistLine}
            </TruncatedText>
          ) : null}
