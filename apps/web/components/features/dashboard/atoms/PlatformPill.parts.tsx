  ...
  return (
    <span
      className={cn(
        ...
        !defaultExpanded &&
          'max-w-0 opacity-0 group-hover/pill:max-w-48 group-hover/pill:opacity-100 group-focus-within/pill:max-w-48 group-focus-within/pill:opacity-100',
        defaultExpanded && 'max-w-48 opacity-100'
      )}
    >
      {primaryText}
    </span>
