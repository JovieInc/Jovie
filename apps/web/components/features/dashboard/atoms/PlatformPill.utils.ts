...
function getLayoutClasses(
  ...
  if (collapsed) {
    return cn(
      'inline-grid max-w-6 grid-cols-[18px_0fr] items-center gap-0.5 overflow-hidden rounded-lg px-[3px] py-[3px]',
      !defaultExpanded &&
      ...
      defaultExpanded &&
        'max-w-33 grid-cols-[18px_minmax(0,1fr)] lg:max-w-41'
    );
  }
  return 'inline-flex min-h-6 max-w-full items-center gap-1.5 rounded-lg px-2 py-[3px]';
}
