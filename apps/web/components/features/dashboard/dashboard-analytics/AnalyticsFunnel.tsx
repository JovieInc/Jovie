      ...
      {stages.map((stage, index) => {
        ...
        return (
          <div key={stage.label} className='w-full flex flex-col items-center'>
            ...
            <div
              className='relative transition-colors duration-cinematic ease-subtle'
            ...
            >
              <ContentSurfaceCard
                className={`
                  ...
                  ${isLast ? 'border-primary/20 ring-1 ring-primary/15 bg-gradient-to-r from-[color-mix(in_srgb,var(--color-accent-purple)_12%,var(--linear-bg-surface-1))] to-surface-1' : ''}
