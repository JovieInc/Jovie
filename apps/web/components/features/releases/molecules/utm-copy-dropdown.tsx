  ...
  const triggerButton = (
    ...
    >
      <span className='relative flex h-4 w-4 items-center justify-center'>
        <Copy
          className={`absolute h-4 w-4 transition-[transform,opacity] duration-subtle ${
            isCopied ? 'scale-50 opacity-0' : 'scale-100 opacity-100'
          }`}
        />
        <Check
          className={`absolute h-4 w-4 text-success-token transition-[transform,opacity] duration-subtle ${
