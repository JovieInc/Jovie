    ...
    >
      ...
      <span
        className={cn(
          ...
          compact ? 'mt-0.5 text-xs' : 'mt-1 text-[22px]'
        )}
      >
        {datePill.day}
      </span>
            ...
            {subtitle ? (
              <p
                className={cn(
                  ...
                  compact ? 'text-[9px] leading-[1.25]' : 'text-app'
                )}
              >
                {subtitle}
              </p>
