    ...
    >
      ...
      {canBuyTickets ? (
        <a
          ...
          className={cn(
            'inline-flex min-h-11 shrink-0 items-center rounded-[14px] border px-3 text-xs font-semibold tracking-[-0.01em] transition-[border-color,background-color,opacity] duration-subtle hover:opacity-90',
        ...
        <span
          className={cn(
            'inline-flex min-h-11 shrink-0 items-center rounded-[14px] border px-3 text-xs font-semibold tracking-[-0.01em]',
            getTicketStatusClassName(item.date.ticketStatus, canBuyTickets)
          )}
        >
          {getTicketStatusLabel(item.date.ticketStatus, canBuyTickets)}
