...
export const PROFILE_DRAWER_MENU_ITEM_CLASS =
  'flex w-full items-center gap-3 rounded-xl px-4 py-3 text-left text-[14px] font-book text-white/92 transition-colors duration-150 ease-out hover:bg-white/[0.05] focus-visible:bg-white/[0.06] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-inset active:bg-white/[0.08]';

export const PROFILE_DRAWER_DANGER_ITEM_CLASS =
  'flex w-full items-center gap-3 rounded-xl px-4 py-3 text-left text-[14px] font-book text-red-400/88 transition-colors duration-150 ease-out hover:bg-red-400/[0.06] focus-visible:bg-red-400/[0.07] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400/50 focus-visible:ring-inset active:bg-red-400/[0.09]';
