...
function ShowcaseBoardCard({
  ...
  return (
    <article className='rounded-3xl border border-white/8 bg-white/[0.03] p-4 shadow-[0_28px_84px_rgba(0,0,0,0.32)]'>
      ...
      <div className='rounded-3xl border border-white/8 bg-surface-1 p-3'>
        {children}
      </div>
    </article>
  );
      ...
      <DemoClientProviders>
        <div data-testid='demo-showcase-tim-white-profile'>
          <div className='flex min-h-screen items-center justify-center bg-surface-0 px-5 py-10'>
            <div
              className='w-full max-w-90 rounded-3xl border border-white/8 bg-surface-1 p-4 shadow-[0_32px_100px_rgba(0,0,0,0.46)]'
