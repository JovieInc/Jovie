...
const PRIMARY_ARTIST = INTERNAL_DJ_DEMO_PERSONA.profile.displayName;

// ── Assignees ──

export const DEMO_ASSIGNEES: DemoAssignee[] = [
  { id: 'a1', name: PRIMARY_ARTIST, initials: 'CH', color: '#6C7AFF' },
...
export const DEMO_RELEASES: DemoRelease[] = [
  ...
  },
  {
    ...
    displayId: 'REL-148',
    title: 'Solar Flare',
    artist: `${PRIMARY_ARTIST} ft. Leo Park`,
    type: 'Single',
  ...
  },
  {
    ...
    artist: `${PRIMARY_ARTIST} & Mira Chen`,
    type: 'Single',
    releaseDate: 'TBD',
    status: 'draft',
    priority: 'none',
