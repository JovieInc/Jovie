      ...
      <div role='alert' aria-live='assertive' aria-atomic='true'>
        ...
        {canRetry ? (
          <button
            ...
            className='mt-2 inline-flex h-7 items-center rounded-[8px] border border-subtle px-2.5 text-2xs font-medium text-secondary-token transition-colors duration-fast hover:border-white/15 hover:text-primary-token focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white/20 disabled:opacity-50'
          >
            Retry message
          </button>
        ) : null}
