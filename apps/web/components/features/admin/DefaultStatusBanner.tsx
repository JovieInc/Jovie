...
export function DefaultStatusBanner({
  ...
  if (isUnavailable) {
    ...
    badgeTone = 'border-default bg-surface-2';
    Icon = HelpCircle;
  } else if (isAlive) {
  ...
  return (
    <Card
      className='border-default bg-surface-1'
    ...
    >
      <CardContent className='flex flex-col gap-4 p-4 sm:p-6 md:flex-row md:items-center md:justify-between'>
        ...
        <div className='mt-2 flex flex-row justify-between gap-4 border-t border-default pt-3 text-sm text-tertiary-token sm:mt-0 sm:flex-col sm:gap-2 sm:border-t-0 sm:pt-0 md:text-right'>
