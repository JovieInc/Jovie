    ...
    <div className='flex items-center gap-2 text-[12px] text-secondary-token'>
      ...
      <Select value={pageSizeValue} onValueChange={setPageSizeValue}>
        <SelectTrigger
          ...
          className='h-8 w-20 rounded-[6px] border-subtle bg-surface-0 px-2 text-[12px] text-secondary-token hover:border-default hover:bg-surface-1 hover:text-primary-token'
        >
          <SelectValue />
        </SelectTrigger>
        <SelectContent>
