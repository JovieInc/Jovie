      ...
      <div className='flex h-full min-h-0 flex-col'>
        ...
        {isEmpty ? (
          ...
          <>
            ...
            {entityHeader && (
              <div className='shrink-0 overflow-hidden px-4.5 pt-4 pb-3.5'>
                {entityHeader}
              </div>
            )}
            ...
            {/* Tabs */}
            {tabs && (
              <div className='shrink-0 border-b border-(--linear-app-frame-seam) px-4.5 py-2 [&>*]:w-full'>
                {tabs}
              </div>
            )}

            {/* Scrollable content */}
            <div className='flex-1 min-h-0 space-y-4 overflow-y-auto overflow-x-hidden overscroll-contain px-4.5 py-4.5'>
              {children}
            </div>

            {/* Footer */}
            {footer && (
              <div className='shrink-0 border-t border-(--linear-app-frame-seam) bg-(--linear-bg-surface-0) px-4.5 py-3'>
                {footer}
              </div>
            )}
          </>
