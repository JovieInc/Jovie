...
const contentSurfaceCardVariants = cva(
  'border border-(--linear-app-frame-seam) bg-[color-mix(in_oklab,var(--linear-app-content-surface)_97%,var(--linear-bg-surface-0))]',
  {
    variants: {
      surface: {
        default: 'rounded-[10px]',
        details:
          'rounded-[10px] bg-[color-mix(in_oklab,var(--linear-app-content-surface)_98%,var(--linear-bg-surface-0))]',
        marketing: 'rounded-xl',
        nested:
          'rounded-[9px] bg-[color-mix(in_oklab,var(--linear-app-content-surface)_99%,var(--linear-bg-surface-0))]',
...
export const CONTENT_SURFACE_CARD_CLASSNAME =
  'rounded-[10px] border border-(--linear-app-frame-seam) bg-[color-mix(in_oklab,var(--linear-app-content-surface)_96%,var(--linear-bg-surface-0))]';
