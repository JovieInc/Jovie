        ...
        <ToolbarMenuRow
          ...
          trailingVisual={
            category.selectedIds.length > 0 ? (
              <span className='inline-flex h-5 min-w-5 items-center justify-center rounded-md border border-[color-mix(in_oklab,var(--app-shell-frame-seam)_44%,transparent)] bg-[color-mix(in_oklab,var(--color-bg-surface-1)_30%,transparent)] px-1 text-3xs tabular-nums text-tertiary-token'>
