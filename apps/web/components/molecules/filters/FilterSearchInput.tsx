      ...
      <div className='relative'>
        ...
        <input
          ...
          className={cn(
            ...
            'focus-visible:border-(--color-border-focus) focus-visible:bg-[color-mix(in_oklab,var(--color-bg-surface-1)_44%,transparent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/14'
          )}
