    ...
    <div className='relative'>
      <div className='relative'>
        ...
        <input
          ...
          className={cn(
            'w-full rounded-lg border border-[color-mix(in_oklab,var(--app-shell-frame-seam)_48%,transparent)] bg-[color-mix(in_oklab,var(--color-bg-surface-1)_34%,transparent)] py-1.5 pl-8 pr-6 text-xs',
            'text-primary-token placeholder:text-tertiary-token',
            'transition-[background-color,border-color,box-shadow] duration-subtle',
            'focus-visible:border-(--linear-border-focus) focus-visible:bg-[color-mix(in_oklab,var(--color-bg-surface-1)_44%,transparent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/14'
          )}
