...
const DRAWER_HEADER_ICON_BUTTON_CLASSNAME =
  'h-[26px] w-[26px] border-transparent bg-transparent hover:border-subtle hover:bg-surface-1 focus-visible:border-(--linear-border-focus) focus-visible:bg-surface-1';
