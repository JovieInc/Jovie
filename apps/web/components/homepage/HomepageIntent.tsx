    ...
    >
      {showIntro ? (
        <>
          ...
          <p className='homepage-hero-subhead mt-6 max-w-[680px] self-center text-center text-base leading-[1.58] tracking-[-0.015em] text-white/68 sm:text-lg'>
            {HERO_COPY.subhead}
          </p>
        </>
      ) : null}
      ...
      <div className='relative mt-4 w-full max-w-[888px]'>
        <button
          ...
          className='absolute left-0 top-1/2 z-[1] hidden h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full border border-white/[0.05] bg-white/[0.025] text-white/56 transition-[background-color,border-color,color,opacity] duration-subtle hover:border-white/[0.1] hover:bg-white/[0.05] hover:text-white disabled:pointer-events-none disabled:opacity-0 sm:inline-flex'
        >
        ...
        >
          {PILLS.map(pill => (
            <button
              ...
              className='shrink-0 whitespace-nowrap rounded-full border border-white/[0.05] bg-white/[0.025] px-[15px] py-[8px] text-xs font-medium tracking-[-0.012em] text-white/62 transition-[background-color,border-color,color] duration-subtle hover:border-white/[0.1] hover:bg-white/[0.04] hover:text-white/84 focus-visible:border-white/[0.18] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/8'
            >
              {pill.label}
            </button>
          ))}
        ...
        <button
          ...
          onClick={() => scrollPills(1)}
          className='absolute right-0 top-1/2 z-[1] hidden h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full border border-white/[0.05] bg-white/[0.025] text-white/56 transition-[background-color,border-color,color,opacity] duration-subtle hover:border-white/[0.1] hover:bg-white/[0.05] hover:text-white disabled:pointer-events-none disabled:opacity-0 sm:inline-flex'
        >
