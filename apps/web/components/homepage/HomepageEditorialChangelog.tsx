...
/**
 * A small projection of published customer-facing releases. The version URL
 * stays beside each card so a preview cannot become an unlinked product claim.
 */
...
export function HomepageEditorialChangelog() {
  const { changelog } = HOMEPAGE_LAUNCH_COPY.certified;
