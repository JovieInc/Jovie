  ...
  return (
    ...
    >
      ...
      <RhythmHeartbeatLine
        ...
        variant='section'
      />
      <div className='absolute left-1/2 top-[52%] h-px w-[168vw] -translate-x-1/2 bg-gradient-to-r from-transparent via-[var(--color-accent)]/18 to-transparent opacity-70 blur-[0.5px]' />
...
function RhythmHeartbeatLine({
  ...
  return (
    <svg
      aria-hidden='true'
      className={cn(
        'pointer-events-none absolute z-0 overflow-visible text-[var(--color-accent)]',
        variant === 'section'
