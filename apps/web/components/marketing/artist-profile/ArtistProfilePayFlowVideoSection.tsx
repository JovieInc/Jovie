...
export function ArtistProfilePayFlowVideoSection({
 ...
 className='relative z-10 inline-flex items-center gap-2 rounded-full bg-surface-1 px-5 py-3 text-sm font-medium text-primary-token text-primary-token transition hover:bg-surface-1'
 >
 <Play
 aria-hidden='true'
 ...
 <div
 aria-hidden='true'
 className='relative z-10 size-8 animate-spin rounded-full border-2 border-subtle border-t-subtle'
 />
 )}
 </div>
 ) : null}
