...
export function ReleaseSidebarHeader({
  ...
  return (
    <div className='flex items-center justify-between border-b border-[rgba(255,255,255,0.05)] px-4 py-2 min-h-11 shrink-0'>
      <div className='min-w-0 flex-1'>
        <div className='text-[13px] font-[510] text-primary-token truncate'>
          {titleText}
        </div>
        {artistName && (
          <div className='text-[13px] text-tertiary-token truncate'>
            {artistName}
          </div>
        )}
      </div>
