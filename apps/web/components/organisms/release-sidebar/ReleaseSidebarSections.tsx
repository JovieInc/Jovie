  ...
  if (normalizedNames.length === 0) {
    ...
    return (
      <button
        ...
        className='rounded-sm hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/55 focus-visible:ring-offset-2 focus-visible:ring-offset-(--color-bg-page)'
      >
        {fallback}
      </button>
    );
