...
const CHECKBOX_STYLES = cn(
  ...
  'rounded-sm border border-subtle bg-surface-0 text-(--linear-accent) transition-colors duration-100 ease-out data-[state=checked]:border-(--linear-accent) data-[state=checked]:bg-(--linear-accent) data-[state=checked]:text-white data-[state=indeterminate]:border-(--linear-accent) data-[state=indeterminate]:bg-(--linear-accent) data-[state=indeterminate]:text-white focus-visible:ring-1 focus-visible:ring-(--linear-border-focus)'
);
