        ...
        {children && (
          <div className='w-full max-w-xl'>
            <div className='relative group'>
              ...
              {/* Content card */}
              <div className='relative bg-surface-0 backdrop-blur-xl rounded-2xl border border-subtle shadow-xl hover:shadow-2xl transition-shadow duration-subtle p-8'>
                {children}
              </div>
            </div>
