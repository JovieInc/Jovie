        ...
        {children && (
          <div className='w-full max-w-xl'>
            <div className='relative group'>
              ...
              {/* Content card */}
              <div className='relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl border border-subtle shadow-xl transition-colors duration-200 ease-out p-8'>
                {children}
              </div>
            </div>
