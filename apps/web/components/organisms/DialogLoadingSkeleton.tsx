          ...
          <div className='space-y-1.5'>
            {rowIds.map(rowId => (
              <DrawerSurfaceCard
                key={rowId}
                variant='card'
                className='flex min-h-14 items-center gap-3 rounded-xl border border-(--app-shell-frame-seam) bg-[color-mix(in_oklab,var(--color-bg-surface-1)_88%,var(--color-bg-surface-0))] px-2.5'
              >
