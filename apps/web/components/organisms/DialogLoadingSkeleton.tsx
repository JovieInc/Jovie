          ...
          <div className='space-y-1.5'>
            {rowIds.map(rowId => (
              <DrawerSurfaceCard
                key={rowId}
                variant='card'
                className='flex min-h-[56px] items-center gap-3 rounded-[10px] border border-(--linear-app-frame-seam) bg-[color-mix(in_oklab,var(--linear-bg-surface-1)_88%,var(--linear-bg-surface-0))] px-2.5'
              >
