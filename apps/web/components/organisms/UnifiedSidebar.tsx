    ...
    <div className='flex w-full items-center'>
      {isInSettings ? (
        <Link
          ...
          className={cn(
            'inline-flex h-7 items-center gap-1.5 rounded-md px-1 text-app tracking-tight text-sidebar-item-foreground transition-[background] duration-normal ease-interactive hover:bg-sidebar-accent focus-visible:outline-none focus-visible:bg-sidebar-accent [font-weight:var(--font-weight-nav)]',
        ...
        <UserButton
          ...
          trigger={
            <button
              ...
              className={cn(
                'flex h-7 items-center gap-1.5 rounded-md px-1 transition-[background] duration-normal ease-interactive hover:bg-sidebar-accent focus-visible:outline-none focus-visible:bg-sidebar-accent',
                'group-data-[collapsible=icon]:justify-center'
              )}
            >
