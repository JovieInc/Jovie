...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'flex h-7 shrink-0 items-center rounded-md px-1.5 text-2xs font-medium text-sidebar-item-icon outline-none transition-all duration-slow ease-out focus-visible:bg-sidebar-accent [&>svg]:size-3.5 [&>svg]:shrink-0',
