...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'flex h-7 shrink-0 items-center rounded-md px-2 text-2xs font-medium tracking-tight text-sidebar-muted outline-none transition-all duration-slow ease-interactive focus-visible:bg-sidebar-accent [&>svg]:size-3.5 [&>svg]:shrink-0',
