...
export function FloatingClaimBar() {
  ...
  return (
    ...
    >
      <div
        className='w-full max-w-[calc(100vw-32px)] sm:max-w-[600px] overflow-hidden rounded-[24px] border border-[var(--linear-border-subtle)] bg-[var(--linear-bg-surface-0)] p-2 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.4)] backdrop-blur-xl supports-[backdrop-filter]:bg-[var(--linear-bg-surface-0)]/80'
        style={{
          boxShadow:
