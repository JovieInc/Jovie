      ...
      <Container size='homepage'>
        <div className='relative mx-auto max-w-[var(--linear-content-max)]'>
          ...
          <div className='reveal-on-scroll flex flex-col items-center text-center gap-5 mb-16'>
            ...
            <p className='max-w-lg marketing-lead-linear text-[var(--linear-text-secondary)]'>
          ...
          >
            {REPLACES.map(item => (
              ...
              >
                ...
                <p className='text-[15px] font-medium text-[var(--linear-text-primary)] line-through opacity-60'>
                  {item.name}
                </p>
                <p className='mt-1 text-[13px] text-[var(--linear-text-tertiary)] line-through'>
                  {item.price}
                </p>

                {/* Pain point */}
                <p className='mt-4 text-[13px] leading-relaxed text-[var(--linear-text-tertiary)]'>
                  {item.painPoint}
                </p>
                ...
                <div className='my-5 flex items-center gap-3'>
                  ...
                  />
                  <span className='text-[11px] font-medium uppercase tracking-wider text-[var(--linear-text-tertiary)]'>
                    Replaced by Jovie
                  </span>
                  <div
                    className='h-px flex-1'
                ...
                <div className='flex gap-2.5'>
                  <ArrowRight
                    ...
                    aria-hidden='true'
                  />
                  <p className='text-[14px] leading-relaxed text-[var(--linear-text-secondary)]'>
                    {item.jovieDoes}
                  </p>
                </div>
              </div>
          ...
          {/* Summary */}
          <p className='reveal-on-scroll mt-10 text-center text-[14px] text-[var(--linear-text-tertiary)]'>
