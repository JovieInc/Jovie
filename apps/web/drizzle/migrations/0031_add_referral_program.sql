...
CREATE INDEX IF NOT EXISTS "referral_codes_user_id_idx" ON "referral_codes" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "referral_commissions_stripe_invoice_id_idx" ON "referral_commissions" USING btree ("stripe_invoice_id");
