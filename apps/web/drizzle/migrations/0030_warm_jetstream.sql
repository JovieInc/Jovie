...
--> statement-breakpoint
ALTER TABLE "social_links" ADD COLUMN "version" integer DEFAULT 1 NOT NULL;--> statement-breakpoint
ALTER TABLE "stripe_webhook_events" ADD COLUMN "processed_at" timestamp;--> statement-breakpoint
ALTER TABLE "stripe_webhook_events" ADD COLUMN "stripe_created_at" timestamp;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "status" "user_status" DEFAULT 'active' NOT NULL;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "billing_version" integer DEFAULT 1 NOT NULL;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "last_billing_event_at" timestamp;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "waitlist_entry_id" uuid;--> statement-breakpoint
...
CREATE INDEX "idx_users_waitlist_entry_id" ON "users" USING btree ("waitlist_entry_id");