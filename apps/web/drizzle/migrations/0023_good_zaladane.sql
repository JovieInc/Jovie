DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'task_agent_status') THEN
...
BEGIN
  ...
  END IF;
END $$;--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "audience_blocks" (
...
--> statement-breakpoint
ALTER TABLE "creator_profiles" ADD COLUMN IF NOT EXISTS "next_task_number" integer DEFAULT 1 NOT NULL;--> statement-breakpoint
ALTER TABLE "notification_subscriptions" ADD COLUMN IF NOT EXISTS "birthday" text;--> statement-breakpoint
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'audience_blocks_creator_profile_id_creator_profiles_id_fk') THEN
    ALTER TABLE "audience_blocks" ADD CONSTRAINT "audience_blocks_creator_profile_id_creator_profiles_id_fk" FOREIGN KEY ("creator_profile_id") REFERENCES "public"."creator_profiles"("id") ON DELETE cascade ON UPDATE no action;
  END IF;
END $$;--> statement-breakpoint
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'audience_blocks_audience_member_id_audience_members_id_fk') THEN
    ALTER TABLE "audience_blocks" ADD CONSTRAINT "audience_blocks_audience_member_id_audience_members_id_fk" FOREIGN KEY ("audience_member_id") REFERENCES "public"."audience_members"("id") ON DELETE set null ON UPDATE no action;
  END IF;
END $$;--> statement-breakpoint
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'tasks_creator_profile_id_creator_profiles_id_fk') THEN
    ALTER TABLE "tasks" ADD CONSTRAINT "tasks_creator_profile_id_creator_profiles_id_fk" FOREIGN KEY ("creator_profile_id") REFERENCES "public"."creator_profiles"("id") ON DELETE cascade ON UPDATE no action;
  END IF;
END $$;--> statement-breakpoint
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'tasks_release_id_discog_releases_id_fk') THEN
    ALTER TABLE "tasks" ADD CONSTRAINT "tasks_release_id_discog_releases_id_fk" FOREIGN KEY ("release_id") REFERENCES "public"."discog_releases"("id") ON DELETE set null ON UPDATE no action;
  END IF;
END $$;--> statement-breakpoint
DO $$
BEGIN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'tasks_source_template_id_release_task_template_items_id_fk') THEN
    ALTER TABLE "tasks" ADD CONSTRAINT "tasks_source_template_id_release_task_template_items_id_fk" FOREIGN KEY ("source_template_id") REFERENCES "public"."release_task_template_items"("id") ON DELETE set null ON UPDATE no action;
  END IF;
END $$;--> statement-breakpoint
