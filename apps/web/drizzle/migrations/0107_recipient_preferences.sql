CREATE TABLE "recipient_preferences" (
	...
	CONSTRAINT "recipient_preferences_marketing_consent_valid" CHECK (("recipient_preferences"."marketing_opt_in" = false and "recipient_preferences"."marketing_consent_version" is null and "recipient_preferences"."marketing_consent_recorded_at" is null) or ("recipient_preferences"."marketing_opt_in" = true and "recipient_preferences"."marketing_consent_version" is not null and "recipient_preferences"."marketing_consent_version" = 'recipient-marketing-v1' and "recipient_preferences"."marketing_consent_recorded_at" is not null))
);
