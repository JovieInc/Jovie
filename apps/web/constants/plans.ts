...
export const CANONICAL_PLANS: readonly CanonicalPlan[] = [
  {
    ...
    yearlyPriceUsd: null,
    monthlyPriceLabel: '$0',
    features: ENTITLEMENT_REGISTRY.free.marketing.features as readonly string[],
  ...
  },
  {
    ...
    features: ENTITLEMENT_REGISTRY.pro.marketing.features as readonly string[],
  ...
  },
  {
    ...
    features: ENTITLEMENT_REGISTRY.max.marketing.features as readonly string[],
    ctaLabel: 'Start Free Trial',
