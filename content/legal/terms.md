...
- You must provide accurate and updated information during onboarding.
- Each account is tied to a single individual; sharing credentials is not permitted.
- You are responsible for maintaining the secrecy of authentication tokens.
...
- Fraud, abuse, or behavior that violates these Terms
- Repeated policy violations or spamming activity
...
- Upload content that infringes copyrights or contains hate speech
- Attempt to reverse engineer or disrupt our infrastructure
- Use the platform for spam, phishing, or abusive outreach

## Intellectual Property

### Your Content

You retain ownership of what you publish on your profile. By using Jovie you grant us a limited license to host and display your content.
...
Jovie is provided "as is" and we cannot guarantee uptime or fitness for a particular use. We disclaim liability for:

- Service interruptions or data loss caused by maintenance or outages
- Issues stemming from third-party integrations (Spotify, Stripe, Statsig, etc.)
- Indirect damages such as lost profits or lost opportunities

## Changes to These Terms

We may modify the Terms from time to time. We will notify you via email, dashboard notices, or in-app banners for material changes. Continued use after notice means you accept the updates.
...
Questions about these Terms should be sent to legal@jov.ie.
