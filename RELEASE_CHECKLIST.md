...
| Runtime performance baseline | `pnpm run ios:runtime-performance` passed locally after `e1df2767fc`; average Chat to Profile to Chat shell transition was `2.725s` monotonic time with `0.185s` CPU time and `59695.770 kB` peak physical memory. | Baseline captured under JOV-2712 |
