## TODO - Link Manager UX Densify (Created by Cascade)
- [x] Reduce card padding/height (~10–15%), darken borders slightly, thin dark-mode borders, add hover/active micro-interactions.
- [x] Soften URL typography (smaller size, reduced opacity, trimmed protocol/path).
