...
For writing or voice work, load `$GSTACK_ROOT/references/VOICE.md` on demand. Host instructions, user preferences and repo canon govern; this reference creates no new approval gate.
