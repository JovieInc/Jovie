...
Use this skill before any design-related work. It is an execution workflow subordinate to repo canon and DESIGN.md
...
rg -n "^## " DESIGN.md docs/design-system/DETAILS.md
```

Read DESIGN.md once, then only the linked detail section needed for the task.
Instruction-only refactors preserve design policy; they do not need a visual
proposal or screenshot gate unless rendered UI also changes.
