...
5. **Durable hardening check:** For every VALID & ACTIONABLE or VALID BUT ALREADY FIXED comment, ask: "does this need a durable test, rule, or skill update?" Add the narrowest durable guard when the answer is yes:
