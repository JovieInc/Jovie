...
one-price-per-zone model can't do. On Base the rails are effectively free
...
| Build our own 402 rails / facilitator | Not needed | **Do not build**: solved off-the-shelf; build only the resource + price config |
