...
|---|---:|---|---|---|
| GBrain health summary | Daily 07:15 local | `scripts/symphony/jobs/gbrain-health-summary.ts` | Telegram/Slack + `ops/gbrain-health/latest` | One Tailscale HTTP probe plus bounded local diagnostics |
