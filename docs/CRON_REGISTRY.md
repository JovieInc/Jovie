...
| 5 | onboardingScriptAggregation | Every day | Onboarding deterministic-script self-improvement (JOV-3806): recomputes per-line conversion counters, mines lint-clean LLM candidates, promotes/retires variants |
