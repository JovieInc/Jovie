...
| `Actions Cache Supersede` | `11,41 * * * *` UTC | Deletes superseded `main` caches: keeps the newest per allowlisted family, drops `pnpm-node-modules-v1-*`. | `.github/workflows/actions-cache-supersede.yml` |
