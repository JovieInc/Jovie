...
| `rich-text/` | Shared bounded Tiptap JSON contract used by task descriptions and Library documents | `RichTextDocument`, `normalizeRichTextDocument`, `richTextDocumentToPlainText` |
