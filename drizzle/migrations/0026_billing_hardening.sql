...
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "billing_version" integer DEFAULT 1 NOT NULL;

-- Add last billing event timestamp for event ordering (skip stale events)
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "last_billing_event_at" timestamp;
...
ALTER TABLE "stripe_webhook_events" ADD COLUMN IF NOT EXISTS "stripe_created_at" timestamp;
