...
2. [`FLEET.md`](./FLEET.md) — closed-loop agent org, admission, founder day, default-alive scoreboard.
3. [`PRODUCT.md`](./PRODUCT.md) — customer value and product bottlenecks.
