...
3. Edit only task files → publish the first coherent commit as a draft, then
   consume rolling CI while implementation continues ([`docs/PR_FLOW.md`](docs/PR_FLOW.md)).
