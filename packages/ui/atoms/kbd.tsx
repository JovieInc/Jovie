...
const Kbd = React.forwardRef<HTMLSpanElement, KbdProps>(
  ({ className, ...props }, ref) => (
    <span
      ref={ref}
      className={cn(
        'inline-flex items-center justify-center rounded-md border border-(--accents-3) bg-surface-2 px-1.5 py-0.5 font-sans text-[10px] font-medium text-secondary-token',
