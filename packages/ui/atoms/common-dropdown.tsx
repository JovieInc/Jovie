  ...
  function renderDefaultTrigger() {
    ...
    return (
      <button
        type='button'
        className={cn(
          'inline-flex h-6 w-6 items-center justify-center rounded-md text-tertiary-token transition-colors duration-normal ease-interactive hover:bg-interactive-hover hover:text-secondary-token active:bg-interactive-active focus-visible:outline-none focus-visible:bg-interactive-hover',
          triggerClassName
        )}
