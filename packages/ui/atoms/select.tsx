...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className='h-3.5 w-3.5 shrink-0 opacity-70 [stroke-width:1.5] text-(--linear-text-tertiary)' />
  ...
  (
    ...
    const content = (
      ...
      >
        ...
        <SelectPrimitive.Viewport className={viewportClassNames}>
          {children}
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(MENU_LABEL_BASE, className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(SELECT_ITEM_BASE, className)}
    {...props}
  >
