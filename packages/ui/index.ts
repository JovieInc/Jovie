...
export {
  ATTENTION_MOTION_PURPOSES,
  ATTENTION_MOTION_TERMINATION_EVENTS,
  type AttentionMotionEvaluation,
  type AttentionMotionProposal,
  type AttentionMotionPurpose,
  type AttentionMotionTerminationEvent,
