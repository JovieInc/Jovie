...
/**
 * Pure mapping from the single playback authority's state to what a preview
 * selector surface may show. A surface is "active" only when BOTH identity
 * fields match; equal ids with different provenance stay selectable.
 */
