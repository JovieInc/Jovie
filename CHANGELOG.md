...
- **[internal] Real-media audio compatibility rail (JOV-4387):** a hash-pinned, synthetic fixture corpus now covers every canonical format and truncated-container failure in real Chromium decoding, explicitly preserving the distinction between upload acceptance, MIME capability, and direct decode support.
