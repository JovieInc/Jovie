...
## [Unreleased]
- [internal] **Forward-only launch component compliance (JOV-4482):** a machine-readable manifest now locks six canonical UI contracts, their documented Button/Card variants and Storybook evidence, and exact owned debt ceilings for raw colors, arbitrary elevation, native button clones, and local loading primitives.
