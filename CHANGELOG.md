...
## [Unreleased]
- **Presence becomes the artist's recurring visibility workspace (JOV-4799/JOV-4800):** single-artist accounts keep Library, Contacts, Calendar, and Presence flat while multi-artist accounts group them under the selected artist; Presence summarizes search visibility, answer readiness, audience quality, and monitored pages; Gmail and Calendar authorization live only in Settings → Connections; and the Artist Profiles page links to Fan Notifications and Instant Merch where those outcomes materially extend profile discovery.
