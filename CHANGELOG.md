...
- [internal] **Tasks and scripts share one focused editor:** Format task context, turn private ideas into reviewed scripts, and hand off only an approved revision.
