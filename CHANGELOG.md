...
- **Public artist profiles now feel more like a native music app:** releases swipe one full-width card at a time, album art stays clean and square, Music rows and the floating navigation are quieter, Alerts has a clear next step, menus fit their content, and opening Events no longer triggers a location permission prompt.
