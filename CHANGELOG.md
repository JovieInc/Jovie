...
## [Unreleased]
- **Frequently asked questions collapse cleanly and stay stable:** closed answers no longer reserve empty space, opening one keeps the section width fixed, and reduced-motion users get immediate keyboard focus and disclosure state changes.
