...
## [Unreleased]
- [internal] **Forward-only launch component compliance (JOV-4482):** a machine-readable manifest now audits six launch UI sources, locks the Button, Card, and EmptyState contracts to typed and Storybook evidence, and records exact owned debt ceilings for raw colors, arbitrary elevation, native button clones, and local loading primitives.
