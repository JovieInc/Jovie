...
- [internal] **x402 payment-gated artist resources spike (GitHub #12750)**: conditional GO for per-artist MCP + press-kit proxy gating via Cloudflare x402-proxy template; adds cost/latency models, wrangler example vars, and spike runner (`docs/product/x402-payment-gated-artist-resources-spike.md`).
