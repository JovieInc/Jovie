...
## [Unreleased]
- **Artist Profiles landing is a proof-led conversion journey (JOV-4503):** claim form as hero focal point with free-to-start support, shared CTA intent registry, shared snap rail for outcomes, no decorative eyebrows, and final CTA aligned to `/start`.
