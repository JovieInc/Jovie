...
## [Unreleased]
- [internal] **Merge-group visual CI harness repair:** the filtered web workspace can resolve the repository Chromatic config again, while DB-free mobile overflow coverage excludes only the two database-backed public-profile redirects and keeps them in database-provisioned runs.
