...
- [internal] **Ovie HUD shipping cockpit consolidation**: `/hud` now redirects to canonical `/app/admin/ops`, ships Taste Inbox + CLI auth status panels on Ops, and keeps the local `scripts/ovie-hud.sh` launcher for deterministic operator sessions.
