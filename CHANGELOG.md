...
## [Unreleased]
- **Public artist profiles get polish + regression coverage (JOV-4436):** malformed website links are suppressed, FAQ sources stay environment-relative, empty tour/merch FAQs no longer render, payment links leave Follow, location facts distinguish hometown vs based-in, latest-release cards show type/year metadata, and carousel peeks no longer clip CTAs.
