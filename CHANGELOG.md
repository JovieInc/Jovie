...
> Releases now support audio upload with waveform preview and snippet trim.

### Added

- **Release audio upload + trim (JOV-2929)**: adds audio upload, waveform preview, and snippet trim for releases.
