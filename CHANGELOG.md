...
- **Mac app stays open after the workspace appears (JOV-5086):** a successful early app paint is no longer mistaken for a failed load and replaced by the Retry screen seconds later.
