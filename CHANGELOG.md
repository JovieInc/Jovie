...
> Library grid now supports aspect-ratio-aware thumbnails and S/M/L density toggle.

### Added

- **Library grid density + aspect ratios (JOV-2933)**: adds aspect-ratio-aware thumbnails and a persisted S/M/L card-size toggle.
