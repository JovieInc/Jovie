...
- **AI usage is easier to understand:** Jovie now shows one rolling weekly message limit with a single warning threshold, consistent warning/error colors, and a compact account-menu meter across plans.
