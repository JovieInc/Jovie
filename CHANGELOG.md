...
- [internal] **Typecheck feedback and regression ratchet (JOV-4250)**: pinned native TypeScript batch checking cuts cold full-repo P95 from 294.93s to 27.99s and leaf-edit P95 from 97.51s to 4.89s, while an independent stable-compiler merge gate, exact-error safety probe, process-aware resource ceilings, deduplicated draft-agent CI handoff, and nightly rolling P50/P95 benchmarks preserve correctness and prevent performance drift.
