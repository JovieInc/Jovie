...
> Visual QA capture pipeline now validates responsive breakpoints.

### Added

- **Visual QA breakpoint checks (JOV-1947)**: adds responsive breakpoint capture validation to the visual QA pipeline.
