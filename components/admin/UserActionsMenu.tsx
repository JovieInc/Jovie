...
export function UserActionsMenu({ user, open, onOpenChange }: UserActionsMenuProps) {
    ...
    return (
        <DropdownMenu open={open} onOpenChange={onOpenChange}>
            ...
            >
                <DropdownMenuItem onClick={handleCopyClerkId} className={geistTableMenuItemClass}>
