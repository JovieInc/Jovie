...
export const cardTokens = {
  ...
  variants: {
    ...
    analytics:
      'relative overflow-hidden rounded-2xl border border-subtle/80 bg-surface-1/90 backdrop-blur-sm p-6 shadow-[0_1px_1px_rgba(0,0,0,0.04)] dark:shadow-[0_1px_1px_rgba(0,0,0,0.2)] ring-1 ring-inset ring-black/5 dark:ring-white/10 before:pointer-events-none before:absolute before:inset-0 before:bg-gradient-to-br before:from-black/[0.03] before:via-transparent before:to-transparent dark:before:from-white/10 hover:bg-surface-1 hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_6px_16px_rgba(0,0,0,0.35)] transition-all duration-300 ease-out',
