...
export const cardTokens = {
  ...
  variants: {
    ...
    analytics:
      'rounded-xl border border-black/[0.08] dark:border-white/[0.08] bg-surface-1 p-5 hover:border-black/[0.12] dark:hover:border-white/[0.12] transition-colors duration-150 ease-out',
