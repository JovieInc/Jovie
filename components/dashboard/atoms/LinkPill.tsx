...
export function LinkPill({
  ...
  const trailing = (
    <button
      ...
      ref={setReferenceRef}
      className='inline-flex h-6 w-6 items-center justify-center rounded-full bg-surface-2/30 text-secondary-token transition-colors hover:bg-surface-2 hover:text-primary-token focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-0 active:scale-[0.97]'
      {...getReferenceProps()}
    >
      <Icon name='MoreHorizontal' className='h-4 w-4 opacity-90' />
    </button>
  );
