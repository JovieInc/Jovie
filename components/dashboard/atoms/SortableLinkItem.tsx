      ...
      >
        ...
        <div className='flex items-center gap-2 p-2'>
          ...
          <button
            ...
            w-5 h-5 text-tertiary-token hover:text-secondary-token
          ...
          <div className='flex-1 min-w-0'>
            ...
            {isEditing ? (
              ...
              <button
                ...
                disabled={disabled}
                className='text-left text-sm font-medium text-primary-token hover:text-secondary-token transition-colors truncate w-full'
                aria-label={`Edit ${link.title}`}
              >
                {link.title}
              </button>
            ...
            <div className='flex items-center gap-2 mt-1' aria-hidden='true'>
              ...
              <span className='text-xs text-tertiary-token truncate'>
