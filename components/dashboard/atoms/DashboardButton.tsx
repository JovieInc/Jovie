    ...
    return (
      <button
        className={cn(
          ...
          'text-primary border border-border border-opacity-30',
    ...
    return (
      <button
        className={cn(
          ...
          isActive
            ? 'bg-surface-2 border border-border border-opacity-30 text-primary ring-1 ring-accent'
            : 'bg-surface-1 border border-border border-opacity-30 text-secondary hover:bg-surface-2 hover:text-primary',
          className
        )}
        {...props}
      >
    ...
    return (
      <button
        className={cn(
          ...
          isActive
            ? 'bg-surface-2 text-primary shadow-sm border border-border border-opacity-30'
            : 'text-secondary hover:text-primary hover:bg-surface-2 border border-border border-opacity-20',
          'btn-press',
          className
        )}
      ...
      >
        {children}
        {isPro && (
          <span className='ml-auto inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium bg-surface-2 text-secondary border border-border border-opacity-30'>
            Pro
          </span>
        )}
      </button>
