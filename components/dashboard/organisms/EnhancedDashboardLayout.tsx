        ...
        <div className='bg-surface-1 rounded-2xl p-6 shadow-sm border border-subtle'>
          ...
          <div className='mb-6'>
            <div className='relative'>
              <Icon
                name='Search'
                className='absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-tertiary-token'
              />
              <Input
                type='text'
              ...
              {searchQuery && (
                <button
                  type='button'
                  onClick={clearSearch}
                  className='absolute right-3 top-1/2 -translate-y-1/2 text-tertiary-token hover:text-secondary-token'
                >
            ...
            <div className='flex items-center justify-between mt-3'>
              ...
              <button
                type='button'
                className='inline-flex items-center text-sm text-secondary-token hover:text-primary-token'
              >
          ...
          >
            ...
            {filteredLinks.length === 0 && (
              <div className='text-center py-12'>
                <div className='mx-auto w-16 h-16 rounded-full bg-surface-2 flex items-center justify-center mb-4'>
                  <Icon name='Search' className='w-6 h-6 text-tertiary-token' />
                </div>
                <h3 className='text-lg font-medium text-primary-token mb-1'>
                  No links found
                </h3>
