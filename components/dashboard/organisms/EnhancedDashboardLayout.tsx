...
import { PhoneMockupPreview } from '../molecules/PhoneMockupPreview';
...
export function EnhancedDashboardLayout({
  ...
  // Categorize links
  const categorizedLinks = filteredLinks.reduce((acc, link) => {
  ...
  const getCategoryInfo = (category: string) => {
    ...
    return info[category as keyof typeof info] || { title: category, type: 'other' as const };
  };
      ...
      <div className="flex-1">
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Manage Links</h1>
