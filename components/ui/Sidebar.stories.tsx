...
const meta: Meta<typeof Sidebar> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'New sidebar-08 style implementation for the dashboard layout.',
      },
    },
  },
};
      ...
      <div className="flex-1 flex flex-col">
        <div className="border-b p-4">
          ...
          <p className="text-muted-foreground">
            This demonstrates the new sidebar-08 implementation with preserved functionality.
          </p>
        </div>
        <div className="flex-1 p-4 space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
              <div className="flex items-center space-y-0 pb-2">
                <h3 className="tracking-tight text-sm font-medium">Analytics</h3>
              </div>
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Default sidebar-08 implementation with navigation, header, and footer sections.',
      },
    },
  },
};
      ...
      <div className="flex h-screen w-full">
        ...
        <div className="flex-1 flex flex-col">
          <div className="border-b p-4">
            ...
            <p className="text-muted-foreground">
              The sidebar collapses to icon-only mode while preserving all functionality.
            </p>
          </div>
