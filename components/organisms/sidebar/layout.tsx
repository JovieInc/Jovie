...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar='input'
      className={cn(
        'h-8 w-full bg-sidebar-input-background border border-sidebar-input-border shadow-none focus-visible:border-(--color-border-focus) focus-visible:ring-2 focus-visible:ring-ring/24',
        className
      )}
      {...props}
    />
