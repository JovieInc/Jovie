        ...
        <DropdownMenuContent align='end' className='w-72' sideOffset={8}>
          ...
          <div className='px-2 pb-1.5'>
            ...
            <select
              ...
              className='h-8 w-full rounded-md bg-surface-1 px-2 text-sm text-primary-token focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--color-border-focus)/20'
            >
