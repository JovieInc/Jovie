  ...
  return (
    ...
    >
      <select
        ...
        className='h-9 shrink-0 rounded-md border-0 bg-transparent px-2 text-xs font-medium text-secondary-token outline-none hover:bg-surface-2 hover:text-primary-token focus-ring-themed'
      >
...
>(function RichTextEditor(
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: `${styles.editor} focus-visible:bg-[color-mix(in_oklab,var(--color-border-focus)_10%,transparent)]`,
  ...
  return (
    ...
    >
      <div className='flex min-h-11 items-center border-b border-subtle bg-surface-0'>
        {editor ? (
