...
export const DRAWER_BUTTON_CLASSNAME =
  'border font-caption tracking-tight shadow-none transition-[background-color,border-color,color] duration-subtle focus-visible:outline-none focus-visible:border-(--color-border-focus) focus-visible:ring-2 focus-visible:ring-ring/20';
