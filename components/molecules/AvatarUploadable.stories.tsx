...
import { AvatarUploadable, type AvatarUploadableProps } from './AvatarUploadable';
...
const meta: Meta<typeof AvatarUploadable> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Uploadable Avatar component with radial progress, drag & drop functionality, and accessibility support. Features world-class UX with visual feedback and analytics tracking.',
      },
    },
  },
  tags: ['autodocs'],
...
const mockUpload = (_file: File): Promise<string> => { // File param needed for signature but unused in mock
  return new Promise((resolve, reject) => {
    ...
    setTimeout(() => {
      if (shouldSucceed) {
        ...
        resolve(`https://images.unsplash.com/photo-${Math.random().toString().substr(2, 9)}?w=100&h=100&fit=crop&crop=face`);
      } else {
...
export const DisplayOnly: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Avatar in display-only mode with no upload functionality - perfect for public profiles and read-only contexts.',
      },
    },
  },
};
...
export const UploadableSizes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Uploadable avatars in different sizes, all with hover and interaction states.',
      },
    },
  },
};
...
export const ProgressStates: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Different progress states showing the radial progress animation.',
      },
    },
  },
};
...
export const NoHoverOverlay: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Uploadable avatar without hover overlay - still supports drag & drop and click to upload.',
      },
    },
  },
};
...
export const FallbackUploadable: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Uploadable avatar starting with no image, showing initials fallback with upload capability.',
      },
    },
  },
};
...
export const RoundedUploadable: Story = {
  render: () => {
    const roundedOptions: Array<'none' | 'sm' | 'md' | 'lg' | 'full'> = ['none', 'sm', 'md', 'lg', 'full'];
