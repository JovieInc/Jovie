      ...
      <LayoutGroup>
        <div className='flex min-w-max gap-3 p-4'>
          {weeks.map(week => (
            ...
            >
              <div className='flex items-baseline justify-between border-b border-(--color-border-subtle) pb-1'>
                <span className='text-xs font-semibold uppercase tracking-wide text-(--color-text-secondary-token)'>
                  {formatShort(week.friday)}
                </span>
                <span className='text-3xs text-(--color-text-tertiary-token)'>
                  Fri
                </span>
              </div>
