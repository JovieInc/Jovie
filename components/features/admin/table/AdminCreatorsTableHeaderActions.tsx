  ...
  return (
    <div className='flex items-center gap-1'>
      ...
      <AppIconButton
        ...
        className='h-8 w-8 rounded-full bg-transparent text-quaternary-token hover:bg-surface-1 hover:text-secondary-token focus-visible:ring-1 focus-visible:ring-(--color-border-focus)/25 [&_svg]:h-3.5 [&_svg]:w-3.5'
