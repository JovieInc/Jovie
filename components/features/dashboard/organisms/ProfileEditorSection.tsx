...
function ProfileIdentityFieldRow({
  ...
  return (
    <div
      className={cn(
        'space-y-1.5 border-b border-subtle px-2.5 py-2.5 last:border-b-0 sm:px-3',
        className
      )}
    >
      ...
      {editing ? (
        ...
        <button
          type='button'
          className={cn(
            'w-full rounded-md border border-transparent px-3 py-2.5 text-center transition-[background-color,border-color,color] duration-subtle hover:border-subtle hover:bg-surface-1 focus-visible:outline-none focus-visible:border-(--color-border-focus) focus-visible:ring-2 focus-visible:ring-ring/20 active:bg-surface-2',
            tone === 'primary'
          ...
          <ProfileIdentityFieldRow
            ...
            input={
              <Input
                ...
                onBlur={onInputBlur}
                className='min-h-12 rounded-md border-default bg-surface-0 text-center text-mid font-semibold tracking-tighter text-primary-token'
              />
            }
          />
          <ProfileIdentityFieldRow
            ...
            input={
              <Input
                ...
                onBlur={onInputBlur}
                className='min-h-11 rounded-md border-default bg-surface-0 text-center text-app font-caption tracking-tight text-primary-token'
              />
            }
          />
        </ContentSurfaceCard>
