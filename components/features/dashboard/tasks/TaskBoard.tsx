  ...
  return (
    <section
      ...
      className={cn(
        ...
        isOver &&
          'border-[color-mix(in_oklab,var(--color-border-focus)_70%,transparent)] bg-[color-mix(in_oklab,var(--linear-row-hover)_36%,var(--linear-app-content-surface))]'
      )}
    >
  ...
  return (
    <div
      className={cn(
        ...
        'focus-visible:outline-none focus-visible:border-[color-mix(in_oklab,var(--color-border-focus)_74%,transparent)] focus-visible:shadow-[inset_0_0_0_1px_var(--color-border-focus)]',
        selected &&
          'border-[color-mix(in_oklab,var(--color-border-focus)_70%,transparent)] bg-[color-mix(in_oklab,var(--linear-row-hover)_52%,var(--linear-app-content-surface))]',
