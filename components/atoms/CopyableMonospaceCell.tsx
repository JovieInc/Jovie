...
export const CopyableMonospaceCell = memo(function CopyableMonospaceCell({
  ...
  if (!value) {
    return <span className='text-2xs font-normal text-tertiary-token'>—</span>;
  }
