...
export function SeekBar({
  ...
  return (
    <input
      ...
      disabled={isDisabled}
      className={cn(
        'seek-range cursor-pointer appearance-none rounded-full accent-(--linear-accent) focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-(--color-border-focus) disabled:cursor-default disabled:opacity-50',
        className
      )}
      style={
        {
