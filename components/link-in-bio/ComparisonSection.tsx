  ...
  return (
    <div className='mx-auto max-w-7xl px-6 lg:px-8'>
      ...
      <div className='mx-auto max-w-5xl'>
        <div className='bg-surface-0 backdrop-blur-sm border border-subtle rounded-2xl overflow-hidden'>
          {/* Header */}
          <div className='grid grid-cols-3 gap-0 bg-surface-2'>
            ...
            <div className='p-6 font-semibold text-transparent bg-linear-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text border-l border-subtle'>
              Jovie
            </div>
          </div>
          ...
          {comparisons.map((comparison, index) => (
            ...
            >
              ...
              <div className='p-6 font-medium text-primary-token border-l border-subtle bg-linear-to-r from-blue-500/5 to-purple-500/5'>
                {comparison.jovie}
              </div>
            </div>
          ))}
        ...
        <div className='mt-12 text-center'>
          <div className='mx-auto max-w-3xl bg-linear-to-r from-blue-600/10 via-purple-600/10 to-cyan-600/10 dark:from-blue-400/10 dark:via-purple-400/10 dark:to-cyan-400/10 rounded-2xl p-8 border border-blue-200/20 dark:border-blue-400/20'>
            <p className='text-xl font-medium text-primary-token leading-relaxed'>
              <span className='text-transparent bg-linear-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text font-semibold'>
                Bottom line:
              </span>{' '}
