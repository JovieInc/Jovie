    ...
    <div className='mx-auto max-w-7xl px-6 lg:px-8'>
      <div className='mx-auto max-w-4xl text-center mb-20'>
        <h2 className='text-4xl font-semibold tracking-tight text-primary-token sm:text-5xl lg:text-6xl'>
          The platform that{' '}
          <span className='text-transparent bg-linear-to-r from-green-600 via-blue-600 to-purple-600 dark:from-green-400 dark:via-blue-400 dark:to-purple-400 bg-clip-text'>
            just works
          </span>
        </h2>

        <p className='mt-6 text-xl leading-relaxed text-secondary-token'>
          ...
          {benefits.map(benefit => {
            return (
              <div key={benefit.title} className='relative group'>
                ...
                <div className='relative bg-surface-0 backdrop-blur-sm border border-subtle rounded-2xl p-8 hover:border-default transition-all duration-300 h-full'>
                  {/* Emoji and title */}
                  ...
                  {/* Description */}
                  <p className='leading-relaxed text-secondary-token'>
                    {benefit.description}
                  </p>
                </div>
              </div>
