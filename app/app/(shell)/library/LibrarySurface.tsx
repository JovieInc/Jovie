...
const LIBRARY_CARD_FOCUS_CLASS =
  'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--color-border-focus)/55 focus-visible:ring-offset-2 focus-visible:ring-offset-(--linear-app-content-surface) outline-none';
      ...
      >
        ...
        {hasPreview ? (
          <Button
            ...
            className={cn(
              'system-b-library-preview-overlay absolute inset-0 grid place-items-center transition-opacity duration-subtle ease-subtle focus-visible:outline-none focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-(--color-border-focus)/55',
              isPreviewPlaying
                ? 'opacity-100'
...
function FilterRow({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'system-b-library-filter-row flex h-7 w-full items-center gap-2 border px-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--color-border-focus)/55 focus-visible:ring-offset-2 focus-visible:ring-offset-(--linear-app-content-surface) outline-none',
