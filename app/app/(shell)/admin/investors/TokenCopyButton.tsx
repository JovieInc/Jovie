  ...
  return (
    <span className='inline-flex max-w-full items-center gap-1.5'>
      ...
      <Button
        ...
        className='inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-sm text-tertiary-token transition-[color,opacity] hover:text-secondary-token focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-(--color-border-focus)'
        aria-label={
