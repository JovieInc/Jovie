...
import { FEATURE_FLAGS, useFeatureFlag } from '@/lib/analytics';
...
export default function DashboardLayoutClient({
  ...
  const atomicSidebarEnabled = useFeatureFlag(
    FEATURE_FLAGS.SIDEBAR_ATOMIC_REFACTOR,
    false
  );
        ...
        <div className='flex h-screen overflow-hidden'>
          ...
          {atomicSidebarEnabled ? (
            ...
            <div
              ...
              } fixed lg:relative inset-y-0 left-0 z-50 flex flex-col transition-all duration-300 ease-in-out lg:translate-x-0 border-r border-border border-opacity-20 dark:border-opacity-30 rounded-r-2xl`}
            >
