              ...
              <div className='flex flex-col gap-3 py-2'>
                <div className='flex flex-col gap-1.5'>
                  ...
                  <input
                    ...
                    className='h-8 w-full rounded-sm border border-subtle bg-surface-1 px-3 text-app text-primary-token outline-none transition-colors focus:border-(--color-border-focus)'
                  />
                </div>
                <div className='flex flex-col gap-1.5'>
                  <label
                  ...
                  <textarea
                    ...
                    rows={3}
                    className='w-full resize-none rounded-sm border border-subtle bg-surface-1 px-3 py-2 text-app text-primary-token outline-none transition-colors focus:border-(--color-border-focus)'
                  />
                </div>
              </div>
              <DialogFooter>
