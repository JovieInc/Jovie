...
describe('Ingestion Jobs', () => {
  describe('detectIngestionPlatform', () => {
    ...
    it('detects Stan URLs', () => {
      expect(detectIngestionPlatform('https://stan.me/artist')).toBe('stan');
      expect(detectIngestionPlatform('https://www.stan.store/creator')).toBe(
        'stan'
      );
    });
  ...
  describe('isSupportedIngestionUrl', () => {
    it('returns true for supported platforms', () => {
      ...
      expect(isSupportedIngestionUrl('https://stan.me/artist')).toBe(true);
    });
