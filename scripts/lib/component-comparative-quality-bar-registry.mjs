/**
 * Approved comparative rubric data for JOV-5438 / JOV-5448.
 *
...
export const ATOM_MOLECULE_INVENTORY_RATCHET = deepFreeze([
  ...
  },
  {
    ...
    total: 170,
    sourceSetSha256:
      '97a98cdd1bad180e10959b53eead01b34bdba70f21fe1ad357831c06f9a45ce4',
  },
  {
...
export const COMPARATIVE_QUALITY_BAR = deepFreeze([
  ...
  entry({
    ...
    referenceId: 'shadcn-components',
    referenceUrl: 'https://ui.shadcn.com/docs/components/base/native-select',
    nearestPattern: 'Native Select',
    disposition: 'improve',
    requiredDimensions: [
      'semantic-anatomy',
      'state-completeness',
    ...
    requirements: {
      roles: ['combobox', 'option'],
      states: ['default', 'selected', 'focus-visible', 'disabled', 'invalid'],
      signals: ['aria-invalid', 'aria-describedby'],
