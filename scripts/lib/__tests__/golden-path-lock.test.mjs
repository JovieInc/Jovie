...
const LIVE_JOVIE_HOMEPAGE_SNIPPET = `
  <input placeholder="Search your name" />
  <button type="submit"><span>Find me</span></button>
  <a href="/start" data-primary-cta="true">Find yourself</a>
  <a href="/start">Find me</a>
`;
...
describe('golden-path lock evaluators', () => {
  it('requires the certified name search + Find me → /start', () => {
    ...
    expect(evaluateHomepageHtml(LIVE_JOVIE_HOMEPAGE_SNIPPET)).toMatchObject({
      id: 'homepage-cta',
      ok: true,
    });
    expect(
