...
describe('ci-fast bounded parallel workflow', () => {
  ...
  it('path-selects both workflow contracts and excludes unrelated tests', () => {
    ...
    expect(selectsStructural.test('apps/web/styles/design-system.css')).toBe(
      true
    );
    ...
    expect(
      selectsStructural.test('scripts/invariants/screen-certification.mjs')
    ).toBe(true);
    expect(
      selectsStructural.test('scripts/invariants/screen-certification.test.mjs')
    ).toBe(true);
    expect(selectsStructural.test('scripts/ui-story-coverage-policy.mjs')).toBe(
      true
    );
    expect(
      selectsStructural.test('scripts/storybook-story-quality-guard.mjs')
    ).toBe(true);
    expect(selectsStructural.test('apps/ios/Jovie/ContentView.swift')).toBe(
      false
    );
