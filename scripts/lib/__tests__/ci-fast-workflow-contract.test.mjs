...
describe('ci-fast bounded parallel workflow', () => {
  ...
  it('enforces meaningful Gem rehabilitation policy coverage in structural CI', () => {
    ...
    for (const gemContractCommand of [
      ...
      'python3 -m coverage run --branch scripts/symphony/tests/gem-pr-rehabilitation-contract.test.py',
      'coverage report --include="*/scripts/symphony/gem-repo-drain-cycle.py" --show-missing --precision=2 --fail-under=80',
