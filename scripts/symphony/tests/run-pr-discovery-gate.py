#!/usr/bin/env python3
"""Run PR discovery regressions with complete-inventory coverage."""
import ast
import dis
import json
...
SUITE = ROOT / "scripts/symphony/tests/pr-discovery.test.py"
TARGETS = {
    "symphony-codex-exhausted.py": {"_complete_open_prs", "_autonomous_open_pr_index"},
}
