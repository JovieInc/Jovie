#!/usr/bin/env python3
"""Run producer/consumer regressions with coverage of the composed trust boundary."""
import ast
import dis
import json
...
SUITE = ROOT / "scripts/symphony/tests/priority-gate-proof.test.py"
TARGETS = {
    "gem-priority-gate.py": {"validate_capacity_receipt"},
}
