...
RESEARCH = ROOT / "scripts/symphony/model-registry-research.py"
ROUTER = ROOT / "scripts/symphony/model-router.py"
CONFIG = ROOT / "scripts/symphony/config/model-registry.json"
SNAPSHOT = ROOT / "scripts/symphony/config/model-research/2026-08-17-central-registry.json"
EVALS = ROOT / "scripts/symphony/tests/fixtures/model-routing-evals.json"
