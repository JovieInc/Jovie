...
TARGETS = {
    ...
    "symphony_accepted_completion.py": {"validate_lease", "validate_result", "validate_github_outcome", "github_outcome", "refresh_context", "build_proof", "persist_proof", "reconcile", "parser"},
