#!/usr/bin/env python3
"""Run reconciler regressions with coverage of launcher failure classification."""
import ast
import dis
import json
...
SUITE = ROOT / "scripts/symphony/tests/symphony-reconciler.test.py"
TARGETS = {
    "symphony-reconciler.py": {"classify_launcher_failure"},
}
