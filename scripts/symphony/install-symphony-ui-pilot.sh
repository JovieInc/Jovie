...
WORKFLOW_SRC="$REPO_ROOT/scripts/symphony/WORKFLOW.jovie-ui-pilot.md"
UNIT_SRC="$REPO_ROOT/scripts/symphony/systemd/symphony-ui-pilot.service"
GUARD_SRC="$REPO_ROOT/scripts/symphony/symphony-lease-guard"
RECONCILER_SRC="$REPO_ROOT/scripts/symphony/symphony-reconciler.py"
MODEL_ROUTER_SRC="$REPO_ROOT/scripts/symphony/model-router.py"
MODEL_REGISTRY_SRC="$REPO_ROOT/scripts/symphony/config/model-registry.json"
CAPABILITY_MANIFEST_SRC="$REPO_ROOT/scripts/symphony/config/symphony-reconciler-capabilities.json"
RECONCILER_SERVICE_SRC="$REPO_ROOT/scripts/symphony/systemd/symphony-reconciler.service"
RECONCILER_TIMER_SRC="$REPO_ROOT/scripts/symphony/systemd/symphony-reconciler.timer"
TIMER_LIVENESS_SRC="$REPO_ROOT/scripts/symphony/verify-systemd-timer-cadence.py"
DISK_RECLAIM_SRC="$REPO_ROOT/scripts/symphony/gem-disk-reclaim.py"
...
check_workflow() {
  ...
  python3 "$REPO_ROOT/scripts/symphony/symphony-concurrency-controller.py" \
...
if [ "$LEASE_GUARD_ONLY" -eq 0 ]; then
  ...
  SYMPHONY_RUNTIME_SOURCE_ROOT="$REPO_ROOT/scripts/symphony" \
