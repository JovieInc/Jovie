...
PRO_TEMPLATE_DIR="${REPO_ROOT}/scripts/symphony/launchd/pro"
LAUNCHD_TEMPLATE_DIR="${REPO_ROOT}/scripts/symphony/launchd"
SHIPPER_ENTRYPOINT_SRC="${REPO_ROOT}/scripts/symphony/shipper-gated-entrypoint.py"
SHIPPER_ENTRYPOINT_DST="${HERMES_SCRIPTS}/shipper-gated-entrypoint.py"
CODEX_LAUNCHER_SRC="${REPO_ROOT}/scripts/symphony/codex-launcher.sh"
...
require_cmd plutil
require_cmd shasum
chmod +x "${REPO_ROOT}/scripts/symphony/ship-loop.sh"
