...
readonly -a TARGETS=(
  ...
  "${GEM_ROOT}/scripts/summer-shipping-lead-admitter.mjs"
  "${GEM_ROOT}/scripts/summer-shipping-lead-source.mjs"
...
python3 -m py_compile \
  ...
  "${SOURCE_ROOT}/scripts/symphony/summer_ci_audit.py" \
...
pairs = {
    ...
    "summerShippingLeadSource": (source_root / "scripts/symphony/summer-shipping-lead-source.mjs", gem_root / "scripts/summer-shipping-lead-source.mjs"),
    "summerShippingLeadAdmitter": (source_root / "scripts/symphony/summer-shipping-lead-admitter.mjs", gem_root / "scripts/summer-shipping-lead-admitter.mjs"),
