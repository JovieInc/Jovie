/**
 * Comparative outcome quality bar for Jovie components (JOV-5438).
 *
...
export function runComparativeQualityBar(options = {}) {
  ...
  if (options.approvedOutcomeEntries !== undefined) {
    issues.push(
      ...validateApprovedOutcomeAlignment(options.approvedOutcomeEntries)
    );
  }
