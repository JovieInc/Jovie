const DESIGN_GOVERNANCE_PATHS = new Set([
  ...
  'apps/web/data/designSystem/systemAuthorityMap.ts',
  'apps/web/data/designSystem/systemAuthorityMapValidation.ts',
  ...
  'scripts/design-system-authority-map.test.mjs',
