...
# Restore and save are independently versioned GitHub Actions. #16447 moved
# restore to v6.1.0; save remains on the patched v4.2.3 pin.
ACTION_CACHE_RESTORE_SHA = "55cc8345863c7cc4c66a329aec7e433d2d1c52a9"
ACTION_CACHE_SAVE_SHA = "5a3ec84eff668545956fd18022155c47e93e2684"
ACTION_CACHE_FORBIDDEN_SHA = "0c45773b623bea8c8e75f6c82b208c3cf94ea4f9"
...
def test_production_next_cache_experiment_is_bounded_and_restore_only_by_default() -> None:
    ...
    assert f"actions/cache/restore@{ACTION_CACHE_RESTORE_SHA}" in restore
    ...
    assert f"actions/cache/save@{ACTION_CACHE_SAVE_SHA}" in save
    assert ACTION_CACHE_FORBIDDEN_SHA not in workflow
