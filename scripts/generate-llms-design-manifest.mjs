...
export function buildLlmsDesignManifest({
  ...
  const lines = [
    ...
    '- **Color SoT:** Pen node ZiaWI (`apps/web/design/ziawi-color-sot.json`, `ziawi-color-sot-v1`)',
    '- **Token registry:** `apps/web/styles/design-system.css` (projects ZiaWI; not a color root)',
    ...
    '## Hard Rules',
    '',
    '- Never invent color hexes — project Pen node ZiaWI. Add non-color shared tokens only in `design-system.css`.',
