...
export function buildLlmsDesignManifest({
  ...
  const lines = [
    ...
    '- **Interaction owners:** `apps/web/data/designSystem/interactionRegistry.ts` projected through `UI_OWNERSHIP_REGISTRY`',
    ...
    '- Resolve menu, tooltip, popover, sheet, drawer, dialog, toast, banner, tabs, picker, search, and form behavior through the interaction ownership registry before composing a surface.',
